...
<?php
	...
	try {
		...
		$sql = "INSERT INTO Cours ( idC, typeC, nomC, contenueC, detailC) 
				VALUES 
					('00', 'Word', 'Cours Word 1', 'cours1.php', 'detail de ouf'), 
					('01', 'Word', 'Cours Word 2', 'cours2.php', 'detail de ouf'),
					('02', 'Word', 'Cours Word 3', 'cours3.php', 'detail de ouf'),
					('03', 'Word', 'Cours Word 4', 'cours4.php', 'detail de ouf'),
					('04', 'Excel', 'Cours Excel 1', 'cours1.php', 'detail de ouf'), 
					('05', 'Excel', 'Cours Excel 2', 'cours2.php', 'detail de ouf'),
					('06', 'Excel', 'Cours Excel 3', 'cours3.php', 'detail de ouf'),
					('07', 'Excel', 'Cours Excel 4', 'cours4.php', 'detail de ouf'),
					('08', 'PP', 'Cours Powerpoint 1', 'cours1.php', 'detail de ouf'), 
					('09', 'PP', 'Cours Powerpoint 2', 'cours2.php', 'detail de ouf'),
					('10', 'PP', 'Cours Powerpoint 3', 'cours3.php', 'detail de ouf'),
					('11', 'PP', 'Cours Powerpoint 4', 'cours4.php', 'detail de ouf'),
					('12', 'Oracle', 'Cours Oracle 1', 'cours1.php', 'detail de ouf'), 
					('13', 'Oracle', 'Cours Oracle 2', 'cours2.php', 'detail de ouf'),
					('14', 'Oracle', 'Cours Oracle 3', 'cours3.php', 'detail de ouf'),
					('15', 'Oracle', 'Cours Oracle 4', 'cours4.php', 'detail de ouf')";
		//echo $sql;
		$connexion->exec($sql);
