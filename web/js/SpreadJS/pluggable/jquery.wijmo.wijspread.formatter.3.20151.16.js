...
(function(wijmo)
{
    (function(spread)
    {
        spread.feature("formatter", ["core.common", "core.globalize", "core.migrate"]);
        ...
        })(spread.FormatMode || (spread.FormatMode = {}));
        var FormatMode = spread.FormatMode;
        ...
        })(spread.NumberFormatType || (spread.NumberFormatType = {}));
        var NumberFormatType = spread.NumberFormatType;
        var TimePart;
        (function(TimePart)
        {
        ...
        var DefaultTokens = (function()
            {
                ...
                {
                    return spread._CultureInfo._currentCulture.DateTimeFormat()
                };
                DefaultTokens.NumberFormatInfo = function()
                {
                    return spread._CultureInfo._currentCulture.NumberFormat()
                };
                ...
                DefaultTokens.TrimSquareBracket = function(token)
                {
                    ...
                    {
                        token = spread.StringHelper.TrimStart(token, DefaultTokens.LeftSquareBracket)
                    }
                    if (token[token.length - 1] === DefaultTokens.RightSquareBracket)
                    {
                        token = spread.StringHelper.TrimEnd(token, DefaultTokens.RightSquareBracket)
                    }
                    return token
                };
                ...
                DefaultTokens.AddSquareBracket = function(token)
                {
                    if (!token)
                    {
                        throw new Error(spread.SR.Exp_TokenIsNull);
                    }
                    if (token.length === 0 || token[0] !== DefaultTokens.LeftSquareBracket)
                    {
                        token = spread.StringHelper.Insert(token, 0, DefaultTokens.LeftSquareBracket.toString())
                    }
                    if (token.length === 0 || token[token.length - 1] !== DefaultTokens.RightSquareBracket)
                    {
                        token = spread.StringHelper.Insert(token, token.length, DefaultTokens.RightSquareBracket.toString())
                    }
                    return token
                };
                ...
                DefaultTokens.ReplaceKeyword = function(s, oldString, newString)
                {
                    ...
                    while (true)
                    {
                        var index = spread.StringHelper.IndexOf(strTemp, oldString, 1);
                        if (index > -1)
                        {
                            strTemp = spread.StringHelper.Remove(strTemp, index, oldString.length);
                            strTemp = spread.StringHelper.Insert(strTemp, index, newString);
        ...
        spread.DefaultTokens = DefaultTokens;
        var NumberFormatBase = (function()
            {
                function NumberFormatBase(partLocaleID, dbNumberFormatPart, cultureName)
                {
                    ...
                    if (!cultureName)
                    {
                        self.cultureName = spread._CultureInfo._currentCulture.Name()
                    }
                    else
                    {
                ...
                {
                    return spread.util.asCustomType(this.partLocaleID, "LocaleIDFormatPart")
                };
                NumberFormatBase.prototype.PartDBNumberFormat = function()
                {
                    return spread.util.asCustomType(this.partDbNumberFormat, "DBNumberFormatPart")
                };
                ...
                NumberFormatBase.IsTransform = function(str, currentpos)
                {
                    if (str[currentpos] === '\\')
                    {
                        throw new Error(spread.SR.Exp_InvalidBackslash);
                    }
        ...
        var _StandardDateTimeFormatter = (function()
            {
                ...
                _StandardDateTimeFormatter.prototype.Format = function(obj)
                {
                    try
                    {
                        ...
                        return new spread._DateTimeHelper(obj).localeFormat(this._formatString)
                    }
                    catch(err)
                    {
                        return obj.toString()
                ...
                _StandardDateTimeFormatter.prototype.Parse = function(str)
                {
                    try
                    {
                        ...
                        return spread._DateTimeHelper.parseLocale(str, this._formatString)
                    }
                    catch(err)
                    {
                        return new Date(str)
        ...
        spread._StandardDateTimeFormatter = _StandardDateTimeFormatter;
        var _StandardNumberFormatter = (function()
            {
                ...
                _StandardNumberFormatter.prototype.Format = function(obj)
                {
                    try
                    {
                        ...
                        return new spread._NumberHelper(obj).localeFormat(this._formatString)
                    }
                    catch(err)
                    {
                        return obj.toString()
                ...
                _StandardNumberFormatter.prototype.Parse = function(str)
                {
                    try
                    {
                        ...
                        return spread._NumberHelper.parseLocale(str)
                    }
                    catch(err)
                    {
        ...
        spread._StandardNumberFormatter = _StandardNumberFormatter;
        var NumberFormatText = (function(_super)
            {
                ...
                NumberFormatText.prototype.Format = function(obj)
                {
                    try
                    {
                        var result = spread.Calc.Convert.S(obj);
                        var formatStringTemp = spread.StringHelper.Replace(this._formatString, "\"", "");
                        if (formatStringTemp !== keyword_null && formatStringTemp !== keyword_undefined)
                        {
                            result = spread.StringHelper.Replace(formatStringTemp, "@", result)
                        }
                        return result
                    }
                    catch(err)
        ...
        spread.AutoFormatter = AutoFormatter;
        var CustomNumberFormat = (function()
            {
                function CustomNumberFormat(format, culture)
                {
                    ...
                    if (!culture)
                    {
                        culture = spread._CultureInfo._currentCulture.Name()
                    }
                    if (arguments.length === 0)
                    {
                ...
                CustomNumberFormat.prototype.Init = function(format, culture)
                {
                    ...
                    {
                        throw new Error(spread.SR.Exp_FormatIllegal);
                    }
                    var self = this;
                        ...
                        else if (c === DefaultTokens.RightSquareBracket)
                        {
                            if (isInFormatPart)
                            {
                                if (token)
                                {
                                    ...
                                    var partObject = spread.util.asCustomType(FormatPartBase.Create(part), "FormatPartBase");
                                    if (partObject && !(spread.util.isCustomType(partObject, "ABSTimeFormatPart")))
                                    {
                                        self.AddPart(partObject)
                                    }
                                    else
                                    {
                                        if (spread.util.isCustomType(partObject, "ABSTimeFormatPart"))
                                        {
                                            absTimePart.push(spread.util.asCustomType(partObject, "ABSTimeFormatPart"));
                                            contentToken += token
                                        }
                                        else
                                        {
                ...
                CustomNumberFormat.prototype.ExcelCompatibleFormatString = function()
                {
                    ...
                    {
                        if (!(spread.util.isCustomType(self.numberFormat, "NumberFormatDigital")))
                        {
                            if (self.DBNumberFormatPart())
                            {
                                formatBuilder += (self.DBNumberFormatPart().toString())
                ...
                CustomNumberFormat.prototype.AddPart = function(part)
                {
                    if (!part)
                    {
                        throw new Error(spread.SR.Exp_PartIsNull);
                    }
                    var self = this;
                    if (spread.util.isCustomType(part, "ConditionFormatPart"))
                    {
                        if (!self.conditionFormatPart)
                        {
                            self.conditionFormatPart = spread.util.asCustomType(part, "ConditionFormatPart");
                            ;
                        }
                        else
                        {
                    ...
                    else if (spread.util.isCustomType(part, "ColorFormatPart"))
                    {
                        if (!self.colorFormatPart)
                        {
                            self.colorFormatPart = spread.util.asCustomType(part, "ColorFormatPart")
                        }
                        else
                        {
                            throw new Error(spread.SR.Exp_DuplicatedDescriptor);
                    ...
                    else if (spread.util.isCustomType(part, "LocaleIDFormatPart"))
                    {
                        if (!self.localeIDFormatPart)
                        {
                            self.localeIDFormatPart = spread.util.asCustomType(part, "LocaleIDFormatPart")
                        }
                        else
                        {
                            throw new Error(spread.SR.Exp_DuplicatedDescriptor);
                    ...
                    else if (spread.util.isCustomType(part, "DBNumberFormatPart"))
                    {
                        if (!self.dbNumberFormatPart)
                        {
                            self.dbNumberFormatPart = spread.util.asCustomType(part, "DBNumberFormatPart")
                        }
                        else
                        {
                            throw new Error(spread.SR.Exp_DuplicatedDescriptor);
        ...
        var GeneralFormatter = (function()
            {
                function GeneralFormatter(format, formatMode, cultureName)
                {
                    ...
                    if (cultureName)
                    {
                        self.customerCultureName = spread._CultureInfo.getCulture(cultureName).Name()
                    }
                    else
                    {
                        self.customerCultureName = spread._CultureInfo._currentCulture.Name()
                    }
                }
                GeneralFormatter._needChangeDefaultFormat = function(defaultFormat)
                {
                    ...
                    {
                        var currentCulture = spread._CultureInfo._currentCulture.Name().toLowerCase();
                ...
                GeneralFormatter.DefaultNumberFormatter = function()
                {
                    ...
                    {
                        this.defaultNumberFormatter = new GeneralFormatter("###################0.################", 0, spread._CultureInfo._currentCulture.Name())
                    }
                ...
                GeneralFormatter.DefaultDMMMFormatter = function()
                {
                    ...
                    {
                        this.defaultDMMMFormatter = new GeneralFormatter("d-mmm", 0, spread._CultureInfo._currentCulture.Name())
                    }
                ...
                GeneralFormatter.DefaultMMMYYFormatter = function()
                {
                    ...
                    {
                        this.defaultMMMYYFormatter = new GeneralFormatter("mmm-yy", 0, spread._CultureInfo._currentCulture.Name())
                    }
                ...
                GeneralFormatter.DefaultHMMFormatter = function()
                {
                    ...
                    {
                        this.defaultHMMFormatter = new GeneralFormatter("h:mm", 0, spread._CultureInfo._currentCulture.Name())
                    }
                ...
                GeneralFormatter.DefaultHMMSSFormatter = function()
                {
                    ...
                    {
                        this.defaultHMMSSFormatter = new GeneralFormatter("h:mm:ss", 0, spread._CultureInfo._currentCulture.Name())
                    }
                ...
                GeneralFormatter.DefaultHMMSS0Formatter = function()
                {
                    ...
                    {
                        this.defaultHMMSS0Formatter = new GeneralFormatter("h:mm:ss.0", 0, spread._CultureInfo._currentCulture.Name())
                    }
                ...
                GeneralFormatter.DefaultStandardNumberFormatter = function()
                {
                    ...
                    {
                        this.defaultStandardNumberFormatter = new GeneralFormatter("0.00E+00", 0, spread._CultureInfo._currentCulture.Name())
                    }
                ...
                GeneralFormatter.DefaultStandardPercentFormatter1 = function()
                {
                    ...
                    {
                        this.defaultStandardPercentFormatter1 = new GeneralFormatter("0.00%", 0, spread._CultureInfo._currentCulture.Name())
                    }
                ...
                GeneralFormatter.DefaultStandardPercentFormatter2 = function()
                {
                    ...
                    {
                        this.defaultStandardPercentFormatter2 = new GeneralFormatter("0%", 0, spread._CultureInfo._currentCulture.Name())
                    }
                ...
                GeneralFormatter.DefaultStandardGroupNumberFormatter1 = function()
                {
                    ...
                    {
                        this.defaultStandardGroupNumberFormatter1 = new GeneralFormatter("#,##0.00", 0, spread._CultureInfo._currentCulture.Name())
                    }
                ...
                GeneralFormatter.DefaultStandardGroupNumberFormatter2 = function()
                {
                    ...
                    {
                        this.defaultStandardGroupNumberFormatter2 = new GeneralFormatter("#,##0", 0, spread._CultureInfo._currentCulture.Name())
                    }
                ...
                GeneralFormatter.prototype.findDateTimeGeneralFormatter = function(s, v, formatter, foundCallback)
                {
                    if (formatter && formatter.length > 0)
                    {
                        for (var k in formatter)
                        {
                            ...
                            {
                                var f = formatter[k];
                                var dt = spread._DateTimeHelper.parseLocale(s, f);
                                if (dt && (dt - v === 0))
                                {
                ...
                GeneralFormatter.prototype.FormatString = function(value)
                {
                            ...
                            case 0:
                                if (self.formatters)
                                {
                                    for (var index = 0; index < self.formatters.length; index++)
                                    {
                                        ...
                                        if (spread.util.isCustomType(formatter, "CustomNumberFormat"))
                                        {
                                ...
                                break;
                            case 1:
                                if (spread.util.isCustomType(self.formatters[0], "StandardDateTimeFormatter"))
                                {
                                    return self.formatters[0].FormatString()
                                }
                                break;
                            case 2:
                                if (spread.util.isCustomType(self.formatters[0], "StandardNumberFormatter"))
                                {
                                    return self.formatters[0].FormatString()
                                }
                                break
                    ...
                    else
                    {
                        if (!value)
                        {
                            throw new Error(spread.SR.Exp_ValueIsNull);
                        }
                        self.formatters = keyword_null;
                ...
                GeneralFormatter.prototype.DateTimeFormatInfo = function(value)
                {
                    ...
                    else
                    {
                        ...
                        if (self.formatters)
                        {
                            ...
                            {
                                var formatter = self.formatters[index];
                                if (spread.util.isCustomType(formatter, "IFormatProviderSupport"))
                                {
                ...
                GeneralFormatter.prototype.PositiveExpression = function()
                {
                    ...
                    {
                        return spread.util.asCustomType(self.formatters[0], "CustomNumberFormat")
                    }
                    return keyword_null
                };
                GeneralFormatter.prototype.NegativeExpression = function()
                {
                    ...
                    {
                        return spread.util.asCustomType(self.formatters[1], "CustomNumberFormat")
                    }
                    return keyword_null
                };
                GeneralFormatter.prototype.ZeroExpression = function()
                {
                    ...
                    {
                        return spread.util.asCustomType(self.formatters[2], "CustomNumberFormat")
                    }
                    return keyword_null
                };
                GeneralFormatter.prototype.TextExpression = function()
                {
                    ...
                    {
                        return spread.util.asCustomType(self.formatters[3], "CustomNumberFormat")
                    }
                    return keyword_null
                };
                GeneralFormatter.prototype.GetFormatType = function(obj)
                {
                    ...
                    if (spread.util.isCustomType(formatInfo, "CustomNumberFormat"))
                    {
                        var customFormat = formatInfo.Formatter();
                        if (spread.util.isCustomType(customFormat, "NumberFormatDigital"))
                        {
                            return 1
                        }
                        else if (spread.util.isCustomType(customFormat, "NumberFormatDateTime"))
                        {
                            return 2
                        }
                        else if (spread.util.isCustomType(customFormat, "NumberFormatText"))
                        {
                            return 3
                        }
                    }
                    ...
                    {
                        if (spread.util.isCustomType(formatInfo, "NumberFormatDigital") || spread.util.isCustomType(formatInfo, "StandardNumberFormatter"))
                        {
                            return 1
                        }
                        else if (spread.util.isCustomType(formatInfo, "NumberFormatDateTime") || spread.util.isCustomType(formatInfo, "StandardDateTimeFormatter"))
                        {
                            return 2
                        }
                        else if (spread.util.isCustomType(formatInfo, "NumberFormatText"))
                        {
                            return 3
                        }
                    }
                ...
                {
                    this.Init();
                    if (spread.util.isType(obj, "DateTime"))
                    {
                        var dt = new spread._DateTimeHelper(obj);
                    ...
                    else if (spread.util.isType(obj, "TimeSpan"))
                    {
                        return GeneralFormatter.DefaultLongTimePatternFormatter()
                    }
                    else if (spread.FormatConverter.IsNumber(obj))
                    {
                        var value = spread.FormatConverter.ToDouble(obj);
                        if (value > 1E20)
                        {
                    ...
                    else if (spread.util.isType(obj, "string"))
                    {
                ...
                GeneralFormatter.prototype.GetPreferredDisplayFormatter = function(s, valueRef)
                {
                    ...
                    if (spread.util.isType(v, "DateTime") || spread.util.isType(v, "TimeSpan"))
                    {
                        var result;
                    ...
                    else if (spread.FormatConverter.IsNumber(v))
                    {
                        if (strTemp[0] === DefaultTokens.NumberFormatInfo().currencySymbol[0])
                        {
                            if (spread.StringHelper.Contains(strTemp, DefaultTokens.DecimalSeparator))
                            {
                        ...
                        else if (spread.StringHelper.IndexOf(strTemp, "e", 1) > -1)
                        {
                        ...
                        else if (spread.StringHelper.Contains(strTemp, DefaultTokens.numberGroupSeparator))
                        {
                            if (spread.StringHelper.Contains(strTemp, DefaultTokens.DecimalSeparator))
                            {
                ...
                {
                    if (spread.util.isType(obj, 'boolean'))
                    {
                    ...
                    var value = 0;
                    var isNumber = spread.FormatConverter.IsNumber(obj);
                    if (isNumber)
                    {
                        value = spread.FormatConverter.ToDouble(obj)
                    }
                    if (formatInfo)
                    {
                        ...
                        if (isNumber && formatInfo === this.NegativeExpression())
                        {
                            ...
                            if (spread.util.isCustomType(formatInfo, "CustomNumberFormat"))
                            {
                                var cf = spread.util.asCustomType(formatInfo, "CustomNumberFormat");
                        ...
                        else
                        {
                            ...
                            {
                                if (spread.util.isType(obj, "string"))
                                {
                                    result = obj.toString()
                                }
                            }
                ...
                GeneralFormatter.prototype.InitExcelCompatibleMode = function(format)
                {
                    ...
                    {
                        self.isSingleFormatterInfo = !spread.StringHelper.Contains(format, DefaultTokens.FormatSeparator.toString());
                ...
                GeneralFormatter.prototype.GetFormatInfo = function(obj)
                {
                    ...
                    if (self.FormatMode() === 0)
                    {
                        ...
                        else if (spread.FormatConverter.IsNumber(obj) || spread.util.isType(obj, "boolean"))
                        {
        ...
        spread.GeneralFormatter = GeneralFormatter;
        ...
        var ColorFormatPart = (function(_super)
            {
                ...
                function ColorFormatPart(token)
                {
                    ...
                    {
                        content = spread.StringHelper.Remove(content, 0, "Color".length);
                        var index = -1;
                ...
                ColorFormatPart.EvaluateFormat = function(token)
                {
                    ...
                    {
                        return spread.StringHelper.StartsWith(token, "Color", 1)
                    }
                    else
                    {
        ...
        var DBNumberFormatPart = (function(_super)
            {
                ...
                function DBNumberFormatPart(token)
                {
                    ...
                    if (DBNumberFormatPart.EvaluateFormat(token))
                    {
                        self.token = token;
                        var content = DefaultTokens.TrimSquareBracket(token);
                        var strType = spread.StringHelper.Remove(content, 0, "dbnum".length);
                        ...
                        else
                        {
                            if (start > -1 && end > -1)
                            {
                                ...
                                if (!isNaN(ret))
                                {
                                    ...
                                    strData = spread.StringHelper.Remove(strData, start, end - start + 1);
                                    strData = spread.StringHelper.Insert(strData, start, formatedNumber)
                                }
                                end = -1;
                                start = -1;
                                hasPoint = false
                ...
                DBNumberFormatPart.prototype.NumberString = function(value, dbNumber, isNumber)
                {
                    ...
                    throw new Error(spread.SR.Exp_ValueIllegal);
                };
                ...
                DBNumberFormatPart.EvaluateFormat = function(token)
                {
                    ...
                    if (spread.StringHelper.StartsWith(content, "DBNum", 1))
                    {
                        return true
                    }
                    return false
        ...
        var NumberHelper = (function()
            {
                ...
                NumberHelper.ParseHexString = function(str)
                {
                    ...
                    {
                        throw new Error(spread.SR.Exp_StringIllegal);
                    }
        ...
        var CultureHelper = (function()
            {
                ...
                CultureHelper.CreateCultureInfo = function(cultureID)
                {
                    ...
                    {
                        case 0x0409:
                            return spread._CultureInfo.getCulture(CultureHelper.EnglishUnitedStates);
                        case 0x0411:
                            return spread._CultureInfo.getCulture(CultureHelper.JapanneseJapan);
                        default:
                            return spread._CultureInfo.currentCulture()
                    }
                };
        ...
        var LocaleIDFormatPart = (function(_super)
            {
                ...
                function LocaleIDFormatPart(token)
                {
                    ...
                    {
                        contentTemp = spread.StringHelper.Remove(contentTemp, 0, 1)
                    }
                    else
                    {
                        throw new Error(spread.SR.Exp_TokenIllegal);
                    ...
                    if (minus > -1)
                    {
                        ...
                        contentTemp = spread.StringHelper.Remove(contentTemp, 0, minus)
                    }
                    else
                    {
                ...
                {
                    return spread.StringHelper.Replace(symbol, "\\.", "'.'")
                };
        ...
        var DefaultDateTimeNumberStringConverter = (function()
            {
                ...
                DefaultDateTimeNumberStringConverter.prototype.ConvertTo = function(num, value, isGeneralNumber, locale, dbNumber)
                {
                    ...
                    if (locale != keyword_null && dbNumber != keyword_null && value instanceof Date)
                    {
                        ...
                        strTemp = strTemp.replace(DefaultTokens.ReplacePlaceholder + NumberFormatDateTime.YearFourDigit, new spread._DateTimeHelper(value).localeFormat(NumberFormatDateTime.YearFourDigit));
                        strTemp = strTemp.replace(DefaultTokens.ReplacePlaceholder + NumberFormatDateTime.YearTwoDigit, new spread._DateTimeHelper(value).localeFormat(NumberFormatDateTime.YearTwoDigit));
        ...
        var NumberFormatDateTime = (function(_super)
            {
                ...
                NumberFormatDateTime.prototype._isJanpaneseCulture = function()
                {
                    ...
                    {
                        if (partLocalID.CultureInfo() === spread._CultureInfo.japanCulture())
                        {
                            return true
                        }
                    }
                    else if (this.CultureName() === spread._CultureInfo.japanCulture().Name())
                    {
                        return true
                    }
                    return false
                ...
                NumberFormatDateTime.prototype.DateTimeFormatInfo = function(value)
                {
                    ...
                    if (arguments.length === 0)
                    {
                        ...
                        {
                            return spread._CultureInfo.getCulture(self.baseCultureName()).DateTimeFormat()
                        }
                        return DefaultTokens.DateTimeFormatInfo()
                    }
                    else
                ...
                NumberFormatDateTime.prototype.Format = function(obj)
                {
                    ...
                    try
                    {
                        try
                        {
                            dateTime = spread.Calc.Convert.DT(obj);
                            if (!dateTime)
                            {
                                result = obj.toString()
                            }
                        ...
                        if (dateTime)
                        {
                            ...
                            if (self.PartLocaleID() && self.PartLocaleID().CultureInfo())
                            {
                                result = new spread._DateTimeHelper(dateTime).customCultureFormat(validDTF, self.PartLocaleID().CultureInfo())
                            }
                            else if (self.CultureName())
                            {
                                result = new spread._DateTimeHelper(dateTime).customCultureFormat(validDTF, spread._CultureInfo.getCulture(self.CultureName()))
                            }
                            else
                            {
                                result = new spread._DateTimeHelper(dateTime).localeFormat(validDTF)
                            }
                            if (self.hasJD)
                            {
                                var monthName = self._getMonthName(dateTime.getMonth());
                                result = spread.StringHelper.Replace(result, NumberFormatDateTime.PlaceholderMonthJD, monthName.substr(0, 1))
                            }
                            if (self.absTimeParts)
                            {
                                var span = (spread._DateTimeHelper.___toOADate(dateTime) - spread._DateTimeHelper.___toOADate(self.AbsoluteTime())) * 24 * 60 * 60 * 1000;
                                for (var key = 0; key < self.absTimeParts.length; key++)
                                {
                                    var absPart = self.absTimeParts[key];
                                    ...
                                    if (absTimePartString !== keyword_null && absTimePartString !== keyword_undefined)
                                    {
                                        ...
                                        result = spread.StringHelper.Replace(result, DefaultTokens.ReplacePlaceholder + tempAbsPart, absTimePartString)
                                    }
                                }
                            }
                        }
                    ...
                    {
                        result = spread.FormatConverter.toString(obj)
                    }
                    if (self.NumberStringConverter())
                    {
                        ...
                        else
                        {
                            ...
                            {
                                result = spread.StringHelper.Replace(result, DefaultTokens.ReplacePlaceholder + NumberFormatDateTime.YearFourDigit, new spread._DateTimeHelper(dateTime).localeFormat(NumberFormatDateTime.YearFourDigit));
                                result = spread.StringHelper.Replace(result, DefaultTokens.ReplacePlaceholder + NumberFormatDateTime.YearTwoDigit, new spread._DateTimeHelper(dateTime).localeFormat(NumberFormatDateTime.YearTwoDigit))
                            }
                ...
                NumberFormatDateTime.prototype.Parse = function(s)
                {
                    ...
                    {
                        var dateTimeResult = spread._DateTimeHelper.parseExact(strTemp, self.validDateTimeFormatString, spread._CultureInfo.getCulture(self.CultureName()));
                        if (dateTimeResult)
                        {
                    ...
                    if (!self.exactlyMatch)
                    {
                        try
                        {
                            var resultDate = spread.Calc.Convert.DT(strTemp);
                ...
                NumberFormatDateTime.prototype.FixFormat = function(format)
                {
                    ...
                    var strBuilder = "";
                    var inComments = false;
                    var hasTime = (spread.StringHelper.IndexOf(formatTemp, NumberFormatDateTime.HoursSingleDigit[0], 1) > -1 || spread.StringHelper.IndexOf(formatTemp, NumberFormatDateTime.SecondSingleDigit[0], 1) > -1);
                    var hasDate = (spread.StringHelper.IndexOf(formatTemp, NumberFormatDateTime.YearTwoDigit[0], 1) > -1 || spread.StringHelper.IndexOf(formatTemp, NumberFormatDateTime.DaySingleDigit[0], 1) > -1);
                ...
                {
                    var isHandled = false;
                    if (spread.StringHelper.Contains(format.value, NumberFormatDateTime.AMPMTwoDigit))
                    {
                        format.value = spread.StringHelper.Replace(format.value, NumberFormatDateTime.AMPMTwoDigit, NumberFormatDateTime.StandardAMPMSingleDigit);
                        isHandled = true
                    }
                    var currentDateTimeFormatInfo = this.DateTimeFormatInfo();
                    if (spread.StringHelper.Contains(format.value, NumberFormatDateTime.AMPMSingleDigit))
                    {
                        format.value = spread.StringHelper.Replace(format.value, NumberFormatDateTime.AMPMSingleDigit, NumberFormatDateTime.StandardAMPMSingleDigit);
                    ...
                    if (spread.StringHelper.Contains(format.value, currentAMPM))
                    {
                        format.value = spread.StringHelper.Replace(format.value, currentAMPM, NumberFormatDateTime.StandardAMPMSingleDigit);
                ...
                NumberFormatDateTime.prototype.Replace = function(format, oldToken, newToken, isReplaceInDateFormat, isReplaceInTimeFormat, result, justSearch, isIgnoreCase)
                {
                    ...
                    if (isReplaceInDateFormat || isReplaceInTimeFormat)
                    {
                        var positions = [];
                        var isInDate = true;
                        var hasTime = (spread.StringHelper.IndexOf(result.value, NumberFormatDateTime.HoursSingleDigit[0], 1) > -1 || spread.StringHelper.IndexOf(result.value, NumberFormatDateTime.SecondSingleDigit[0], 1) > -1);
                        var hasDate = (spread.StringHelper.IndexOf(result.value, NumberFormatDateTime.YearTwoDigit[0], 1) > -1 || spread.StringHelper.IndexOf(result.value, NumberFormatDateTime.DaySingleDigit[0], 1) > -1);
                        if (!hasDate && hasTime)
                        {
                            isInDate = false
                        }
                        ...
                        for (; index < result.value.length; index++)
                        {
                            ...
                            if ((isReplaceInDateFormat && DefaultTokens.IsEquals(c, oldToken[tokenCharIndex], isIgnoreCase) && isInDate) || (isReplaceInTimeFormat && DefaultTokens.IsEquals(c, oldToken[tokenCharIndex], isIgnoreCase) && !isInDate))
                            {
                                ...
                                {
                                    spread.ArrayHelper.insert(positions, 0, index)
                                }
                            }
                            if (c === '\"')
                            {
                        ...
                        if (positions.length > 0)
                        {
                            if (!justSearch)
                            {
                                for (index = 0; index < positions.length; index++)
                                {
                                    ...
                                    result.value = spread.StringHelper.Remove(result.value, position, oldToken.length);
                                    result.value = spread.StringHelper.Insert(result.value, position, newToken)
                                }
                            }
                            return true
                        }
        ...
        var NumberFormatDigital = (function(_super)
            {
                ...
                function NumberFormatDigital(format, partLocaleID, dbNumberFormatPart, cultureName)
                {
                    ...
                    if (solidusIndex > -1)
                    {
                        formatTemp = spread.StringHelper.Replace(formatTemp, "\\" + DefaultTokens.QuestionMark, DefaultTokens.Zero);
                ...
                NumberFormatDigital.prototype.NumberFormatInfo = function(value)
                {
                    ...
                    if (arguments.length === 0)
                    {
                        ...
                        if (self.baseCultureName())
                        {
                            return spread._CultureInfo.getCulture(self.baseCultureName()).NumberFormat()
                        }
                        return DefaultTokens.NumberFormatInfo()
                    }
                    else
                ...
                NumberFormatDigital.prototype.Format = function(obj)
                {
                    ...
                    var self = this;
                    var num = spread.FormatConverter.ToDouble(obj);
                    ...
                    {
                        cultureInfo = spread._CultureInfo._currentCulture
                    }
                    if (self.fractionNumeratorFormat && self.fractionDenominatorFormat)
                    {
                        ...
                        if (NumberFormatDigital.GetFraction(num, d, out_integer, out_numerator, out_denominator))
                        {
                            ...
                            if (self.fractionIntegerFormat)
                            {
                                ...
                                {
                                    sb += (new spread._NumberHelper(out_integer.value).customCultureFormat(self.fractionIntegerFormat, cultureInfo));
                                ...
                                {
                                    sb += (new spread._NumberHelper(out_numerator.value).customCultureFormat(numeratorFormat, cultureInfo).replace(/^0*/, ''));
                                    sb += (DefaultTokens.SolidusSign);
                                    sb += (new spread._NumberHelper(out_denominator.value).customCultureFormat(denominatorFormat, cultureInfo).replace(/^0*/, ''))
                                }
                                return sb
                            }
                            else
                            {
                                ...
                                {
                                    sb += (new spread._NumberHelper(value).customCultureFormat(self.fractionNumeratorFormat, cultureInfo).replace(/^0*/, ''));
                                    sb += (DefaultTokens.SolidusSign);
                                    sb += (new spread._NumberHelper(out_denominator.value).customCultureFormat(self.fractionDenominatorFormat, cultureInfo).replace(/^0*/, ''))
                                }
                                return sb
                            }
                        }
                    ...
                    {
                        result = new spread._NumberHelper(num).customCultureFormat(self.EncodeNumberFormat(self.numberFormatString), cultureInfo);
                        if (self.NumberStringConverter())
                        {
                ...
                NumberFormatDigital.prototype.Parse = function(s)
                {
                    ...
                    if (spread.StringHelper.EndsWith(s, DefaultTokens.numberGroupSeparator))
                    {
                        return s
                    }
                    var strTemp = NumberHelper.FixJapaneseChars(s);
                    ...
                    var EIndex = spread.StringHelper.IndexOf(strTemp, DefaultTokens.ExponentialSymbol, 1);
                    var isE = EIndex > -1;
                    if (self.numberFormatString)
                    {
                        ...
                        var tempS = spread.StringHelper.Replace(str, DefaultTokens.numberGroupSeparator, "");
                ...
                NumberFormatDigital.prototype.TrimPercentSign = function(s, out_count)
                {
                    ...
                    {
                        strTemp = spread.StringHelper.Replace(strTemp, percentSymbol, "");
                    ...
                    for (var n = strTemp.length - 1; n > -1; n--)
                    {
                        ...
                        if (this.IsSpecialSymbol(c))
                        {
                            if (char.IsWhiteSpace(c))
                            {
                                ...
                                {
                                    strTemp = spread.StringHelper.Remove(strTemp, n, 1)
                                }
                            }
                            else
                            {
        ...
        var NumberFormatGeneral = (function(_super)
            {
                ...
                function NumberFormatGeneral(format, partLocaleID, dbNumberFormatPart, cultureName)
                {
                    ...
                    if (arguments.length > 0)
                    {
                        if (NumberFormatGeneral.EvaluateFormat(format))
                        {
                            ...
                            {
                                throw spread.SR.Exp_FormatIllegal;
                            }
                ...
                {
                    return spread.StringHelper.Replace(this.fullFormatString, NumberFormatGeneral.GeneralPlaceholder, NumberFormatBase.General)
                };
                NumberFormatGeneral.prototype.Format = function(obj)
                {
                    var self = this;
                    if (spread.FormatConverter.IsNumber(obj))
                    {
                        var allowS = !self.PartLocaleID() ? true : self.PartLocaleID().AllowScience();
                        var d = spread.FormatConverter.ToDouble(obj);
                    ...
                    {
                        var formatTmp = spread.StringHelper.Replace(self.FormatString(), '"', '');
                        formatTmp = DefaultTokens.TrimEscape(formatTmp);
                        if (formatTmp)
                        {
                            return spread.StringHelper.Replace(formatTmp, "General", obj)
                        }
                        return obj
                    }
                    else if (spread.util.isType(obj, "boolean"))
                    {
                        return obj.toString().toUpperCase()
                    }
                    return ""
                ...
                NumberFormatGeneral.prototype.Parse = function(s)
                {
                    ...
                    var hasMin = false;
                    var minIndex = spread.StringHelper.IndexOf(s, "-");
                    if (minIndex > 0)
                    {
                    ...
                    if (spread.StringHelper.Contains(s, "/") || hasMin || spread.StringHelper.Contains(s, ":") || spread.StringHelper.Contains(s, "-"))
                    {
                        var dt = spread._DateTimeHelper.parseLocale(s);
                        if (dt)
                        {
                            return dt
                        }
                    ...
                    {
                        result = this.DigitalFormat().Parse(spread.StringHelper.Remove(s, 0, 1));
                        if (result)
                        {
                            if (spread.util.isType(result, "number"))
                            {
        ...
        spread.CustomFormatterBase = CustomFormatterBase
