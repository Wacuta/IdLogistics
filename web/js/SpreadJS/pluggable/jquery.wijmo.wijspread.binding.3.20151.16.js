...
(function(wijmo)
{
    (function(spread)
    {
        spread.feature("binding", ["core.common"]);
        ...
        spread.CellBindingSource = CellBindingSource;
        var _BindingManager = (function()
            {
                ...
                _BindingManager.prototype.setValue = function(row, col, value)
                {
                    ...
                    var ds = self._dataSource,
                        dsType = self._dataSourceType,
                        DataSourceType = spread._DataSourceType;
                    var colInfo,
                        field;
                    if (dsType !== 4)
                    {
        ...
        spread._BindingManager = _BindingManager;
        ...
        spread._BindingHelper = _BindingHelper
