...
(function(wijmo)
{
    (function(spread)
    {
        spread.feature("conditionalFormat", ["core.common", "core.globalize", "core.stringResource", "core.theme", "core.imageLoader"]);
        var keyword_null = null,
            ...
            CalcConvert = spread.Calc.Convert;
        var StringHelper_TrimStart = spread.StringHelper.TrimStart;
        ...
        })(spread.ConditionType || (spread.ConditionType = {}));
        var ConditionType = spread.ConditionType;
        (function(RuleType)
        {
        ...
        })(spread.RuleType || (spread.RuleType = {}));
        var RuleType = spread.RuleType;
                ...
                ConditionRuleBase.prototype._addRows = function(row, rowCount)
                {
                    ...
                    if (self.ranges)
                    {
                        ...
                        for (var i = 0; i < length; i++)
                        {
                            ...
                            if (range.row >= row)
                            {
                                self.ranges[i] = new spread.Range(range.row + rowCount, range.col, range.rowCount, range.colCount)
                            }
                            else if (range.row < row && row < range.row + range.rowCount)
                            {
                                self.ranges[i] = new spread.Range(range.row, range.col, range.rowCount + rowCount, range.colCount)
                            }
                        }
                    }
                };
                ConditionRuleBase.prototype._addColumns = function(col, colCount)
                {
                    ...
                    if (self.ranges)
                    {
                        ...
                        for (var i = 0; i < length; i++)
                        {
                            ...
                            if (range.col >= col)
                            {
                                self.ranges[i] = new spread.Range(range.row, range.col + colCount, range.rowCount, range.colCount)
                            }
                            else if (range.col < col && col < range.col + range.colCount)
                            {
                                self.ranges[i] = new spread.Range(range.row, range.col, range.rowCount, range.colCount + colCount)
                            }
                        }
                    }
                };
                ConditionRuleBase.prototype._removeRows = function(row, rowCount)
                {
                    ...
                    if (self.ranges)
                    {
                        ...
                        for (var i = 0; i < length; i++)
                        {
                            ...
                            {
                                var newRange = new spread.Range(range.row, range.col, range.rowCount - Math_min(range.row + range.rowCount - row, rowCount), range.colCount);
                        ...
                        for (var j = 0; j < len; j++)
                        {
                            ...
                            spread.ArrayHelper.remove(self.ranges, delRange)
                        }
                    }
                };
                ConditionRuleBase.prototype._removeColumns = function(col, colCount)
                {
                    ...
                    if (self.ranges)
                    {
                        ...
                        for (var i = 0; i < length; i++)
                        {
                            ...
                            {
                                var newRange = new spread.Range(range.row, range.col, range.rowCount, range.colCount - Math_min(range.col + range.colCount - col, colCount));
                                if (newRange.colCount === 0 || newRange.rowCount === 0)
                                {
                                    delList.push(range)
                                }
        ...
        spread.ConditionRuleBase = ConditionRuleBase;
        ...
        spread.RelationCondition = RelationCondition;
                ...
                CellValueRule.prototype.fromJSON = function(settings, isNoneSchema)
                {
                    ...
                    if (settings.ranges)
                    {
                        ...
                        for (var i = 0; i < settings.ranges.length; i++)
                        {
                            ...
                            self.ranges.push(new spread.Range(r.row, r.col, r.rowCount, r.colCount))
                        }
                    }
                    if (settings.style)
                    {
                        self.style = new spread.Style;
        ...
        spread.CellValueRule = CellValueRule;
        ...
        spread.CellValueCondition = CellValueCondition;
        ...
        spread.NumberCondition = NumberCondition;
        ...
        spread.SpecificTextRule = SpecificTextRule;
        ...
        spread.TextCondition = TextCondition;
        var ColorCondition = (function()
            {
                ...
                {
                    return (colorStr === keyword_undefined || colorStr === keyword_null || colorStr === "") ? keyword_null : spread._Color.parse(colorStr)
                };
        ...
        spread.ColorCondition = ColorCondition;
        var FormulaRule = (function(_super)
            {
                ...
                function FormulaRule(formula, style)
                {
                    ...
                    {
                        throw new Error(spread.SR.Exp_InvalidArgument);
                    }
        ...
        spread.FormulaRule = FormulaRule;
                ...
                FormulaCondition.prototype.getExpected = function(evaluator, baseRow, baseCol)
                {
                    ...
                    if (self.formula && self.formula.length > 0)
                    {
                        ...
                        if (v instanceof Array)
                        {
                            ...
                            {
                                return spread.Calc.Errors.NotAvailable
                            }
                        }
                        return v
                    }
        ...
        spread.FormulaCondition = FormulaCondition;
        var DateCondition = (function()
            {
                ...
                DateCondition.prototype.getExpectedDateTime = function(evaluator, baseRow, basecol)
                {
                    ...
                    {
                        return spread._DateTimeHelper.parseLocale(obj)
                    }
                    return keyword_null
                };
        ...
        spread.DateCondition = DateCondition;
        ...
        spread.DateOccurringRule = DateOccurringRule;
        ...
        spread.TextLengthCondition = TextLengthCondition;
        ...
        var Top10Condition = (function()
            {
                ...
                Top10Condition.prototype.evaluate = function(evaluator, baseRow, baseColumn, actualObj)
                {
                    ...
                    if (expectedRank !== keyword_undefined && expectedRank !== keyword_null)
                    {
                        ...
                        if (values)
                        {
                            ...
                            if (spread.ArrayHelper.contains(values, dactual))
                            {
                                return true
                            }
                        }
                ...
                {
                    return new spread.Range(range.row, range.col, Math.min(range.rowCount, sheet.getRowCount()), Math.min(range.colCount, sheet.getColumnCount()))
                };
                                ...
                                if (typeof(o) !== const_undefined && o !== keyword_null && typeof(doubleValue) !== const_undefined && doubleValue !== keyword_null)
                                {
                                    try
                                    {
                                        ...
                                        else
                                        {
                                            if (doubleValue > min)
                                            {
                                                spread.ArrayHelper.remove(values, min);
                                                values.push(doubleValue);
                                                if (spread.ArrayHelper.indexOf(values, min) < 0)
                                                {
                                                    min = doubleValue;
                                ...
                                if (typeof(o) !== const_undefined && o !== keyword_null && typeof(doubleValue) !== const_undefined && doubleValue !== keyword_null)
                                {
                                    try
                                    {
                                        ...
                                        else
                                        {
                                            if (doubleValue < max)
                                            {
                                                spread.ArrayHelper.remove(values, max);
                                                values.push(doubleValue);
                                                if (spread.ArrayHelper.indexOf(values, max) < 0)
                                                {
                                                    max = doubleValue;
                                                    for (var n = 0, valueCount = values.length; n < valueCount; n++)
                                                    {
                ...
                {
                    if (((typeof value === 'number') || (value instanceof Date)) && spread.util.hasCalc())
                    {
        ...
        spread.Top10Condition = Top10Condition;
        ...
        spread.DuplicateRule = DuplicateRule;
        var UniqueCondition = (function()
            {
                ...
                UniqueCondition.prototype.evaluate = function(evaluator, baseRow, baseColumn, actualObj)
                {
                    ...
                    if (expectDuplicated !== keyword_undefined && expectDuplicated !== keyword_null)
                    {
                        ...
                        {
                            if (spread.ArrayHelper.contains(cached, value))
                            {
        ...
        spread.UniqueCondition = UniqueCondition;
        ...
        spread.AverageRule = AverageRule;
        var AverageCondition = (function()
            {
                ...
                AverageCondition.prototype._createExpression = function(name, parameters)
                {
                    ...
                    var expressions = spread.Calc.Expressions,
                        functions = spread.Calc.Functions;
                    ...
                    if (averageFunc)
                    {
                        ...
                        for (var i = 0; i < length; i++)
                        {
                            ...
                            else if (obj instanceof spread.Range)
                            {
                            ...
                            {
                                throw spread.SR.Exp_NotSupport;
                            }
                        }
        ...
        spread.AverageCondition = AverageCondition;
        ...
        var ScaleRule = (function(_super)
            {
                ...
                ScaleRule.prototype._cloneRanges = function(ranges)
                {
                    ...
                    {
                        r = ranges[i];
                        newRanges.push(new spread.Range(r.row, r.col, r.rowCount, r.colCount))
                    }
                    return newRanges
                };
                ...
                ScaleRule.prototype._evaluateColor = function(value, color1, color2)
                {
                    if (0 <= value && value <= 1)
                    {
                        var minColor = spread._Color.parse(color1);
                        var maxColor = spread._Color.parse(color2);
                        ...
                        return new spread._Color(parseFloat((a / 255)), parseInt(r, 10), parseInt(g, 10), parseInt(b, 10)).toString()
                    }
                    return keyword_null
                };
        ...
        var TwoScaleRule = (function(_super)
            {
                ...
                function TwoScaleRule(minType, minValue, minColor, maxType, maxValue, maxColor)
                {
                    ...
                    if (arguments.length === 0)
                    {
                        ...
                        _minColor = new spread._Color(0, 255, 255, 255).toString();
                        _maxType = 2;
                        _maxValue = keyword_null;
                        _maxColor = new spread._Color(255, 99, 190, 123).toString()
                    }
                ...
                TwoScaleRule.prototype._init = function()
                {
                    ...
                    self.expected[0] = new spread._Color(0, 255, 255, 255).toString();
                    self.expected[2] = new spread._Color(255, 99, 190, 123).toString()
                };
        ...
        spread.TwoScaleRule = TwoScaleRule;
        var ThreeScaleRule = (function(_super)
            {
                ...
                function ThreeScaleRule(minType, minValue, minColor, midType, midValue, midColor, maxType, maxValue, maxColor)
                {
                    ...
                    if (arguments.length === 0)
                    {
                        _minType = 1;
                        _minValue = keyword_null;
                        _minColor = new spread._Color(255, 248, 105, 107).toString();
                        _midType = 4;
                        _midValue = 50;
                        _midColor = new spread._Color(255, 255, 235, 132).toString();
                        _maxType = 2;
                        _maxValue = keyword_null;
                        _maxColor = new spread._Color(255, 99, 190, 123).toString()
                    }
                ...
                ThreeScaleRule.prototype._init = function()
                {
                    ...
                    self.scales[2] = new ScaleValue(2, keyword_null);
                    self.expected = new Array(3);
                    self.expected[0] = new spread._Color(255, 248, 105, 107).toString();
                    self.expected[1] = new spread._Color(255, 255, 235, 132).toString();
                    self.expected[2] = new spread._Color(255, 99, 190, 123).toString()
                };
        ...
        spread.ThreeScaleRule = ThreeScaleRule;
        var DataBarRule = (function(_super)
            {
                ...
                function DataBarRule(minType, minValue, maxType, maxValue, color)
                {
                    ...
                    if (arguments.length === 0)
                    {
                        ...
                        _maxType = 7;
                        _maxValue = keyword_null;
                        _color = new spread._Color(255, 99, 142, 198).toString()
                    }
                    var scaleValue1 = new ScaleValue(_minType, _minValue);
                    var scaleValue2 = new ScaleValue(_maxType, _maxValue);
                    _super.call(this, scaleValue1, keyword_null, scaleValue2);
                ...
                DataBarRule.prototype.reset = function()
                {
                    ...
                    self.condition = keyword_null;
                    self.style = keyword_null;
                    self._init(new spread._Color(255, 99, 142, 198).toString());
                    self._stopIfTrue = false;
                    self._priority = 1;
                    self.scales = [];
                ...
                {
                    var rc = new spread.Rect(x + 2, y + 2, w - 4, h - 4),
                        startX = rc.x,
                        startY = rc.y,
                    ...
                    if (width >= 0 && height >= 0)
                    {
                        ...
                        if (obj.isGradient)
                        {
                            ...
                            var tempColor = spread._Color.parse(obj.fillColor),
                                color1 = new spread._Color(tempColor.a, Math_floor(255 * factor + tempColor.r * (1 - factor)), Math_floor(255 * factor + tempColor.g * (1 - factor)), Math_floor(255 * factor + tempColor.b * (1 - factor))).toString(),
                ...
                DataBarRule.prototype.evaluate = function(evaluator, baseRow, baseColumn, actual)
                {
                    ...
                    if (value !== keyword_null && value !== keyword_undefined)
                    {
                        ...
                        {
                            minValue = new spread._DateTimeHelper(minValue).toOADate()
                        }
                        if (maxValue instanceof Date)
                        {
                            maxValue = new spread._DateTimeHelper(maxValue).toOADate()
                        }
        ...
        spread.DataBarRule = DataBarRule;
        ...
        spread.IconCriterion = IconCriterion;
        ...
        spread.IconSetRule = IconSetRule;
                    ...
                    if (valids)
                    {
                        for (var i = 0; i < valids.length; i++)
                        {
                            ...
                            else if (obj !== keyword_undefined && obj !== keyword_null)
                            {
                                ...
                                {
                                    var style = evaluator.getActualStyle(baseRow, baseColumn);
                                    var parsedValue = spread.util.parseText2Value(style, obj, true);
        ...
        spread.AreaCondition = AreaCondition;
        var ConditionalFormats = (function()
            {
                        ...
                        return this.worksheet._bindToAutoRefresh(function(rule)
                            {
                                if (!rule)
                                {
                                    throw new Error(spread.SR.Exp_RuleIsNull);
                                }
                    ...
                    if (this.worksheet)
                    {
                        ...
                        this.worksheet._bindToAutoRefresh(function(rule)
                        {
                            if (rule)
                            {
                                ...
                                spread.ArrayHelper.remove(self.rules, rule)
                            }
                        })(rule)
                    }
                };
                ConditionalFormats.prototype._removeRange = function(srcRange, row, column, rowCount, columnCount)
                {
                    ...
                    if (sourceRowTop !== -1 && sourceColumnLeft !== -1)
                    {
                        if (removeRowTop !== -1 && removeColumnLeft !== -1)
                        {
                            ...
                            {
                                var topLeft = new spread.Range(sourceRowTop, sourceColumnLeft, removeRowTop - sourceRowTop, removeColumnLeft - sourceColumnLeft);
                            ...
                            {
                                var topMid = new spread.Range(sourceRowTop, Math_max(removeColumnLeft, sourceColumnLeft), removeRowTop - sourceRowTop, Math_min(removeColumnRight, sourceColumnRight) - Math_max(removeColumnLeft, sourceColumnLeft) + 1);
                                newRanges.push(topMid)
                            }
                            if (sourceColumnRight - removeColumnRight > 0 && removeRowTop - sourceRowTop > 0)
                            {
                                var topRight = new spread.Range(sourceRowTop, removeColumnRight + 1, removeRowTop - sourceRowTop, sourceColumnRight - removeColumnRight);
                            ...
                            {
                                var midLeft = new spread.Range(Math_max(removeRowTop, sourceRowTop), sourceColumnLeft, Math_min(removeRowBottom, sourceRowBottom) - Math_max(removeRowTop, sourceRowTop) + 1, removeColumnLeft - sourceColumnLeft);
                            ...
                            {
                                var midRight = new spread.Range(Math_max(removeRowTop, sourceRowTop), removeColumnRight + 1, Math_min(removeRowBottom, sourceRowBottom) - Math_max(removeRowTop, sourceRowTop) + 1, sourceColumnRight - removeColumnRight);
                                newRanges.push(midRight)
                            }
                            if (removeColumnLeft - sourceColumnLeft > 0 && sourceRowBottom - removeRowBottom > 0)
                            {
                                var bottomLeft = new spread.Range(removeRowBottom + 1, sourceColumnLeft, sourceRowBottom - removeRowBottom, removeColumnLeft - sourceColumnLeft);
                            ...
                            {
                                var bottomMid = new spread.Range(removeRowBottom + 1, Math_max(removeColumnLeft, sourceColumnLeft), sourceRowBottom - removeRowBottom, Math_min(removeColumnRight, sourceColumnRight) - Math_max(removeColumnLeft, sourceColumnLeft) + 1);
                                newRanges.push(bottomMid)
                            }
                            if (sourceColumnRight - removeColumnRight > 0 && sourceRowBottom - removeRowBottom > 0)
                            {
                                var bottomRight = new spread.Range(removeRowBottom + 1, removeColumnRight + 1, sourceRowBottom - removeRowBottom, sourceColumnRight - removeColumnRight);
                ...
                ConditionalFormats.prototype.removeRuleByRange = function(row, column, rowCount, columnCount)
                {
                    if (this.worksheet)
                    {
                        ...
                        this.worksheet._bindToAutoRefresh(function(row, column, rowCount, columnCount)
                        {
                            ...
                            {
                                spread.ArrayHelper.remove(self.rules, removeRules[k])
                            }
                ...
                ConditionalFormats.prototype.containsRule = function(rule, row, column)
                {
                    if (rule)
                    {
                        if (spread.ArrayHelper.contains(this.rules, rule))
                        {
        ...
        spread.ConditionalFormats = ConditionalFormats
