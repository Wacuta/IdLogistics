...
(function(wijmo)
{
    (function(spread)
    {
        spread.feature("celltype", ["core.common", "core.sheet_action", "core.basecelltype"]);
        ...
        })(spread.EditorValueType || (spread.EditorValueType = {}));
        var EditorValueType = spread.EditorValueType;
        ...
        })(spread.CheckBoxTextAlign || (spread.CheckBoxTextAlign = {}));
        ...
        })(spread.HyperLinkTargetType || (spread.HyperLinkTargetType = {}));
        ...
        var CheckBoxCellType = (function(_super)
            {
                ...
                CheckBoxCellType.prototype.createEditorElement = function(context)
                {
                    ...
                    var zindex = spread.util.getPreferredZIndex(host) + 1000;
                    var $div = $(div);
                    ...
                    if (self._isMouseDownReservedLocation && sheet && hitInfo.isReservedLocation)
                    {
                        ...
                        if (!cellNode._isFirstMouseUp)
                        {
                            if (sheetArea === keyword_null || sheetArea === keyword_undefined || sheetArea === 3)
                            {
                                ...
                                var undoAction = new spread.UndoRedo.CellEditUndoAction(sheet, cellEditInfo);
                ...
                {
                    var self = this;
                    var width = spread.CellTypeContext.getAutoFitWidth(value, self._getDisplayText(value), cellStyle, zoomFactor, context);
                    if (self._textAlign === 0 || self._textAlign === 1)
                    {
                ...
                {
                    var self = this;
                    var height = spread.CellTypeContext.getAutoFitHeight(value, self._getDisplayText(value), cellStyle, zoomFactor, context);
                    if (self._textAlign === 0 || self._textAlign === 1)
                    {
        ...
        spread.CheckBoxCellType = CheckBoxCellType;
        var ButtonCellType = (function(_super)
            {
                ...
                ButtonCellType.prototype.processKeyDown = function(event, context)
                {
                    ...
                    if (!self._isKeyPressed)
                    {
                        ...
                        sheet._bind(spread.Events.SelectionChanged + self._eventNameSpace, function(event, args)
                        {
                            sheet._unbind(spread.Events.SelectionChanged + self._eventNameSpace);
                ...
                {
                    var self = this;
                    var width = spread.CellTypeContext.getAutoFitWidth(value, self._text, cellStyle, zoomFactor, context);
                ...
                {
                    var self = this;
                    var height = spread.CellTypeContext.getAutoFitHeight(value, self._text, cellStyle, zoomFactor, context);
        ...
        spread.ButtonCellType = ButtonCellType;
        var HyperLinkCellType = (function(_super)
            {
                ...
                HyperLinkCellType.prototype.paintValue = function(ctx, value, x, y, w, h, style, options)
                {
                    ...
                    var hAlign = style.hAlign,
                        ...
                        linkTextPosition = self._calcPosition(new spread.Rect(x, y, w, h), linkTextWidth, linkTextHeight, hAlign, vAlign);
                    var clipRect = {
        ...
        spread.HyperLinkCellType = HyperLinkCellType;
        var CustomCellType = (function(_super)
            {
                ...
                CustomCellType.prototype.paint = function(ctx, value, x, y, width, height, style, context)
                {
                    ...
                    spread.CellTypeContext.paintBackground(ctx, x, y, width, height, style.backColor, style.backgroundImage, style.backgroundImageLayout, context.imageLoader);
                    var showBarIconOnly = spread.CellTypeContext.paintConditionalFormats(ctx, value, x, y, width, height, style, context);
                    context.showBarIconOnly = showBarIconOnly;
                    spread.CellTypeContext.paintSparkline(ctx, x, y, width, height, context.sparkline);
                    var showSparklineEx = spread.CellTypeContext.paintSparklineEx(ctx, value, x, y, width, height, context.sheet);
                ...
                {
                    return spread.CellTypeContext.getAutoFitWidth(value, text, cellStyle, zoomFactor, context)
                };
                CustomCellType.prototype.getAutoFitHeight = function(value, text, cellStyle, zoomFactor, context)
                {
                    return spread.CellTypeContext.getAutoFitHeight(value, text, cellStyle, zoomFactor, context)
                };
        ...
        spread.CustomCellType = CustomCellType;
        ...
        var ComboBoxCellType = (function(_super)
            {
                ...
                ComboBoxCellType.prototype.paint = function(ctx, value, x, y, w, h, style, context)
                {
                    ...
                    spread.CellTypeContext.paintBackground(ctx, x, y, w, h, style.backColor, style.backgroundImage, style.backgroundImageLayout, context.imageLoader);
                    var showBarIconOnly = spread.CellTypeContext.paintConditionalFormats(ctx, value, x, y, w, h, style, context);
                    context.showBarIconOnly = showBarIconOnly;
                    spread.CellTypeContext.paintSparkline(ctx, x, y, w, h, context.sparkline);
                    var showSparklineEx = spread.CellTypeContext.paintSparklineEx(ctx, value, x, y, w, h, context.sheet);
                    if (!context.cellOverflowLayout && !showBarIconOnly && !showSparklineEx)
                    {
                    ...
                    if (comboBox)
                    {
                        ...
                        dropDownList.bind(EndEdit, function(event, args)
                        {
                            ...
                            if (keyCode === 37)
                            {
                                ...
                                spread.SpreadActions.navigationLeft.apply(sheet)
                            }
                            else if (keyCode === 39)
                            {
                                sheet._editorStatus = 1;
                                spread.SpreadActions.navigationRight.apply(sheet)
                            }
                            else if (keyCode === 9)
                            {
                                spread.SpreadActions.commitInputNavigationTabNext.apply(sheet)
                            }
                            else if (keyCode === 13)
                            {
                                spread.SpreadActions.commitInputNavigationDown.apply(sheet)
                            }
                            else if (keyCode === 27)
                            {
                                spread.SpreadActions.cancelInput.apply(sheet)
                            }
                ...
                {
                    var width = spread.CellTypeContext.getAutoFitWidth(value, text, cellStyle, zoomFactor, context);
        ...
        spread.ComboBoxCellType = ComboBoxCellType;
        var click = "click",
        ...
        var DropDownList = (function(_super)
            {
                ...
                function DropDownList(left, top, width, height, zindex)
                {
                    ...
                    this._scrollablePanel = new spread.ScrollablePanel(this._DOMObject, this._divList);
                    this._itemHeight = 22;
