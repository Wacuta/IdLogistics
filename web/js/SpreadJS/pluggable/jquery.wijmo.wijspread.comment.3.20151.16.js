...
(function(wijmo)
{
    (function(spread)
    {
        spread.feature("comment", ["core.common", "core.sheet_action"]);
        ...
        })(spread.DisplayMode || (spread.DisplayMode = {}));
        ...
        })(spread.ResizeDirection || (spread.ResizeDirection = {}));
        var ResizeDirection = spread.ResizeDirection;
        var Comment = (function()
            {
                function Comment()
                {
                    var self = this;
                    self._defaultLocation = new spread.Point(9, -18);
                    self._text = "";
                ...
                Comment.prototype.location = function(value)
                {
                    ...
                    {
                        if (value instanceof spread.Point && self._location !== value)
                        {
                ...
                Comment.prototype.textDecoration = function(value)
                {
                    ...
                    {
                        if (spread.TextDecorationType[value] !== keyword_undefined && self._textDecoration !== value)
                        {
                ...
                Comment.prototype.horizontalAlign = function(value)
                {
                    ...
                    {
                        if (spread.HorizontalAlign[value] !== keyword_undefined && self._horizontalAlign !== value)
                        {
                ...
                Comment.prototype.commentState = function(value)
                {
                    ...
                    {
                        if (spread.CommentState[value] !== keyword_undefined && self._commentState !== value)
                        {
                ...
                Comment.prototype.clone = function()
                {
                    ...
                    comment._location = new spread.Point(self._location.x, self._location.y);
                    if (self._defaultLocation)
                    {
                        comment._defaultLocation = new spread.Point(self._defaultLocation.x, self._defaultLocation.y)
                    }
                ...
                Comment.prototype.fromJSON = function(jsonData, isNoneSchema)
                {
                    ...
                    {
                        self._location = new spread.Point(location.x, location.y)
                    }
        ...
        var CommentView = (function()
            {
                ...
                CommentView.prototype._init = function()
                {
                    ...
                    spread.DPIHelper.adjustDevicePixel(self._floatBlockCanvas, null, self._commentManager._sheet);
                    ...
                    $(self._hostContainer).addClass(self._hostContainerClassName).css("position", "absolute");
                    ...
                    spread.DPIHelper.adjustDevicePixel(self._lineCanvas, null, self._commentManager._sheet);
                    ...
                    if (spread.features.touch)
                    {
                        self._touchManager = new spread.CommentTouchManager(self._floatBlockCanvas, self, sheet.parent._touchEventProvider);
                        self._touchManager.attach();
                        self._touchContentManager = new spread.CommentContentTouchManager(self._host, self, sheet.parent._touchEventProvider);
                ...
                CommentView.prototype._convertRelLocationToAbsLocation = function(relLocation)
                {
                    ...
                    if (sheet)
                    {
                        ...
                        if (cellRect.x !== null && cellRect.x !== undefined && cellRect.y !== null && cellRect.y !== undefined && cellRect.width && cellRect.height)
                        {
                            ...
                            absLocation = new spread.Point(cellRect.x + cellRect.width + relLocation.x * zoomFactor - sheetLayout.rowHeaderWidth, cellRect.y + relLocation.y * zoomFactor - sheetLayout.colHeaderHeight)
                        }
                    }
                    return absLocation
                };
                ...
                CommentView.prototype._convertAbsLocationToRelLocation = function(absLocation)
                {
                    ...
                    if (sheet)
                    {
                        ...
                        if (cellRect.x !== null && cellRect.x !== undefined && cellRect.y !== null && cellRect.y !== undefined && cellRect.width && cellRect.height)
                        {
                            ...
                            relLocation = new spread.Point(x, y)
                        }
                    }
                    return relLocation
                };
                ...
                CommentView.prototype._updateStartCoordinate = function()
                {
                    ...
                    var startLocation = new spread.Point(startX, startY);
                    var x = 0,
                        y = 0;
                ...
                CommentView.prototype._updateEndCoordinate = function()
                {
                    ...
                    var endLocation = new spread.Point(endX, endY);
                    var x = 0,
                        y = 0;
                    for (var col = viewportLeftColumn; col < sheet.getColumnCount(); col++)
                    {
                ...
                CommentView.prototype._formatCommentRect = function(targetDom)
                {
                    ...
                    spread.DPIHelper.setSize(self._floatBlockCanvas, width, height);
                ...
                CommentView.prototype._adjustCommentRect = function(adjustedRect)
                {
                    ...
                    {
                        var location = self._convertAbsLocationToRelLocation(new spread.Point(adjustedRect.x, adjustedRect.y)),
                ...
                CommentView.prototype._formatCommentState = function()
                {
                    ...
                    switch (comment.commentState())
                    {
                        case 1:
                            ...
                            spread.FocusHelper.setActiveElement(sheet);
                            break;
                        case 2:
                            commentManager.activateComment(comment);
                            if (!self.isEditing())
                            ...
                            spread.FocusHelper.setActiveElement(keyword_null);
                            break;
                        case 3:
                ...
                CommentView.prototype._formatCommentStyle = function(targetDom)
                {
                    ...
                    $targetDom.css("text-align", spread.HorizontalAlign[comment.horizontalAlign()]);
                    if (comment.padding())
                    {
                ...
                CommentView.prototype._updateLineContainerLayout = function()
                {
                    ...
                    startPoint = new spread.Point(startX, startY);
                    ...
                    {
                        endPoint = new spread.Point(floatBlockCanvasContainerPosition.left + hostContainerPosition.left, floatBlockCanvasContainerPosition.top + hostContainerPosition.top)
                    }
                    else
                    {
                        if (floatBlockCanvasContainerPosition.top + hostContainerPosition.top + $hostContainer.height() < startPoint.y)
                        {
                            endPoint = new spread.Point(floatBlockCanvasContainerPosition.left + hostContainerPosition.left + $hostContainer.width(), floatBlockCanvasContainerPosition.top + hostContainerPosition.top + $hostContainer.height())
                        }
                        else
                        {
                            endPoint = new spread.Point(floatBlockCanvasContainerPosition.left + hostContainerPosition.left + $hostContainer.width(), floatBlockCanvasContainerPosition.top + hostContainerPosition.top)
                        }
                    }
                    ...
                    spread.DPIHelper.setSize(self._lineCanvas, width, height);
                ...
                CommentView.prototype._drawLine = function(start, end)
                {
                    ...
                    ctx.clearRect(0, 0, spread.DPIHelper.getLogicWidth(self._lineCanvas), spread.DPIHelper.getLogicHeight(self._lineCanvas));
                    ctx.beginPath();
                ...
                CommentView.prototype._updateAdornerLayout = function()
                {
                    ...
                    var width = spread.DPIHelper.getLogicWidth(self._floatBlockCanvas),
                        height = spread.DPIHelper.getLogicHeight(self._floatBlockCanvas),
                ...
                CommentView.prototype._drawResizeAdorner = function(ctx, hostMargin, width, height, hostWidth, hostHeight)
                {
                    ...
                    if (self._adornerDrawState === 1 || self._adornerDrawState === 2)
                    {
                        ...
                        var topLeft = new spread.Rect(0, 0, hostMargin, hostMargin);
                        ...
                        var bottomLeft = new spread.Rect(0, height - hostMargin, hostMargin, hostMargin);
                        self._resizeHitRects.push(bottomLeft);
                        var bottomRight = new spread.Rect(width - hostMargin, height - hostMargin, hostMargin, hostMargin);
                        self._resizeHitRects.push(bottomRight);
                        if (hostHeight >= 3 * hostMargin)
                        {
                            var middleLeft = new spread.Rect(0, Math_floor(height / 2 - hostMargin / 2), hostMargin, hostMargin);
                            self._resizeHitRects.push(middleLeft);
                            var middleRight = new spread.Rect(width - hostMargin, Math_floor(height / 2 - hostMargin / 2), hostMargin, hostMargin);
                        ...
                        {
                            var topCenter = new spread.Rect(Math_floor(width / 2 - hostMargin / 2), 0, hostMargin, hostMargin);
                            self._resizeHitRects.push(topCenter);
                            var bottomCenter = new spread.Rect(Math_floor(width / 2 - hostMargin / 2), height - hostMargin, hostMargin, hostMargin);
                ...
                CommentView.prototype._doMoveResizeContainer = function(event)
                {
                    ...
                    if (mouseCapture.capture)
                    {
                        ...
                        if (mouseCapture.resizeDirct == -100)
                        {
                            ...
                            var location = self._convertRelLocationToAbsLocation(new spread.Point(newX, newY));
                        ...
                        else
                        {
                            ...
                            var location = self._convertRelLocationToAbsLocation(new spread.Point(commentResizeRect.x, commentResizeRect.y));
                ...
                CommentView.prototype.detachEditor = function()
                {
                    ...
                    if (self.isEditing())
                    {
                        ...
                        {
                            var action = new spread.UndoRedo.CommentPropertyUndoAction(sheet, comment, comment.text(), $(editor).val(), "text");
                ...
                CommentView.prototype.getCommentRect = function()
                {
                    ...
                    if (self.isOpen())
                    {
                        ...
                        commentRect = new spread.Rect(self._absLocation.x + sheetLayout.headerX + sheetLayout.rowHeaderWidth, self._absLocation.y + sheetLayout.headerY + sheetLayout.colHeaderHeight, self._getActualWidth(), self._getActualHeight())
                    }
                    return commentRect
                };
                CommentView.prototype.getCommentEditAreaRect = function()
                {
                    ...
                    if (self.isOpen())
                    {
                        ...
                        if (commentRect)
                        {
                            ...
                            return new spread.Rect(x, y, width, height)
                        }
                    }
                    return keyword_null
                };
                ...
                CommentView.prototype._doMouseDownToEdit = function(event)
                {
                    ...
                    return spread.util.cancelDefault(event)
                };
                CommentView.prototype._doMouseDownToDragOrResize = function(event)
                {
                    ...
                    mouseCapture.cachedRect = new spread.Rect(comment.location().x, comment.location().y, comment.width(), comment.height());
                    ...
                    var eventHandler = sheet._eventHandler,
                        ...
                        mousePosition = new spread.Point(event.pageX - canvasOffset.left, event.pageY - canvasOffset.top),
                ...
                CommentView.prototype._getAdjustedCommentRect = function(location, width, height)
                {
                    ...
                    return new spread.Rect(left, top, actualWidth / zoomFactor, actualHeight / zoomFactor)
                };
                ...
                CommentView.prototype._doMoveResizeComment = function(event)
                {
                    ...
                    if (mouseCapture.capture)
                    {
                        ...
                        if (mouseCapture.resizeDirct == -100)
                        {
                            var newX = mouseCapture.cachedRect.x + offsetX,
                                newY = mouseCapture.cachedRect.y + offsetY;
                            var absoluteLocation = self._convertRelLocationToAbsLocation(new spread.Point(newX, newY));
                            ...
                            {
                                sheet._doCommand(new spread.UndoRedo.CommentPropertyUndoAction(sheet, comment, comment.location().clone(), location, "location"))
                            }
                        }
                        else
                        {
                            ...
                            var absoluteLocation = self._convertRelLocationToAbsLocation(new spread.Point(resizeRect.x, resizeRect.y));
                            var adjustedRect = self._getAdjustedCommentRect(absoluteLocation, resizeRect.width, resizeRect.height);
                            var location = self._convertAbsLocationToRelLocation(new spread.Point(adjustedRect.x, adjustedRect.y));
                            var transaction = new spread.UndoRedo.CommentUndoTransaction;
                            if (location.x !== comment.location().x || location.y !== comment.location().y)
                            {
                                transaction.add(new spread.UndoRedo.CommentPropertyUndoAction(sheet, comment, comment.location().clone(), location, "location"))
                            }
                            if (adjustedRect.width !== comment.width())
                            {
                                transaction.add(new spread.UndoRedo.CommentPropertyUndoAction(sheet, comment, comment.width(), adjustedRect.width, "width"))
                            }
                            if (adjustedRect.height !== comment.height())
                            {
                                transaction.add(new spread.UndoRedo.CommentPropertyUndoAction(sheet, comment, comment.height(), adjustedRect.height, "height"))
                            }
                ...
                CommentView.prototype._doMouseMove = function(event)
                {
                    ...
                    var eventHandler = sheet._eventHandler,
                        canvasOffset = eventHandler._getCanvasOffset();
                    var point = new spread.Point(event.pageX - canvasOffset.left, event.pageY - canvasOffset.top);
                    if (target)
                    {
        ...
        spread.CommentView = CommentView;
        var CommentManager = (function()
            {
                ...
                CommentManager.prototype._bindEventsOnSheet = function()
                {
                    ...
                    sheet._bind(spread.Events.ColumnChanged, function(event, data)
                    {
                    ...
                    sheet._bind(spread.Events.RowChanged, function(event, data)
                    {
                        var propertyName = data.propertyName;
                    ...
                    sheet._bind(spread.Events.ColumnWidthChanged, function(event, data)
                    {
                        self._updateCommentsLayoutWhenRowColumnChanged()
                    });
                    sheet._bind(spread.Events.RowHeightChanged, function(event, data)
                    {
                        self._updateCommentsLayoutWhenRowColumnChanged()
                    });
                    sheet._bind(spread.Events.CommentChanged, function(event, data)
                    {
                ...
                {
                    var self = this;
                    if (commentView && spread.ArrayHelper.indexOf(self._commentViewList, commentView) === -1)
                    {
                ...
                {
                    this._commentViewList.splice(spread.ArrayHelper.indexOf(this._commentViewList, commentView), 1)
                };
                ...
                CommentManager.prototype.removeComment = function(comment)
                {
                    ...
                    if (comment)
                    {
                        ...
                        commentList.splice(spread.ArrayHelper.indexOf(commentList, comment), 1);
                ...
                {
                    var self = this;
                    if (spread.ArrayHelper.indexOf(self._commentList, comment) !== -1)
                    {
                        return true
                    }
                    return false
        ...
        spread.CommentManager = CommentManager;
        ...
        spread.CommentRender = CommentRender
