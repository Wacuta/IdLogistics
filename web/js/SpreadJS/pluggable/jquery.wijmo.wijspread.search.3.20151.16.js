...
(function(wijmo)
{
    (function(spread)
    {
        spread.feature("search", ["core.common", "core.sheet_ui", "core.stringResource"]);
        ...
        })(spread.EnumeratorOption || (spread.EnumeratorOption = {}));
        ...
        var CellsEnumerator = (function()
            {
                function CellsEnumerator(sheet, searchCondition)
                {
                    ...
                    if (!sheet)
                    {
                        throw new Error(wijmo.spread.SR.Exp_SheetIsNull);
                    }
                    var self = this;
                ...
                CellsEnumerator.prototype.current = function()
                {
                    ...
                    {
                        return new spread.Cell(self.worksheet, self.currentRow, self.currentColumn, self.sheetArea)
                    }
                    return keyword_null
                };
                return CellsEnumerator
            })();
        spread.CellsEnumerator = CellsEnumerator;
        ...
        spread.SearchCondition = SearchCondition;
        ...
        spread.SearchResult = SearchResult;
        ...
        })(spread.SearchFoundFlags || (spread.SearchFoundFlags = {}));
        var SearchFoundFlags = spread.SearchFoundFlags
