...
(function(wijmo)
{
    (function(spread)
    {
        spread.feature("dataValidator", ["core.common"]);
        ...
        var DefaultDataValidator = (function()
            {
                ...
                DefaultDataValidator.prototype.getValidList = function(evaluator, baseRow, baseColumn)
                {
                    ...
                    var self = this;
                    if (self.condition != keyword_null && self.type === 3 && self.condition instanceof spread.AreaCondition)
                    {
                ...
                DefaultDataValidator.prototype.fromJSON = function(settings, isNoneSchema)
                {
                    ...
                    var self = this;
                    if (spread.features.conditionalFormat && settings.condition !== keyword_null && settings.condition !== keyword_undefined)
                    {
                ...
                {
                    var validator = new wijmo.spread["DefaultDataValidator"];
                ...
                DefaultDataValidator.createNumberValidator = function(typeOperator, v1, v2, isIntegerValue)
                {
                    ...
                    var conditionTemp = keyword_null,
                        c1,
                        c2;
                    var comparisonOperator = spread.ComparisonOperator,
                        generalCompareType = spread.GeneralCompareType,
                        relationCompareType = spread.RelationCompareType;
                    switch (typeOperator)
                    {
                        case 6:
                            c1 = new spread.NumberCondition(3, expect1, formula1);
                            c1.integerValue = isIntegerValue;
                            c2 = new spread.NumberCondition(5, expect2, formula2);
                            c2.integerValue = isIntegerValue;
                            conditionTemp = new spread.RelationCondition(1, c1, c2);
                            break;
                        case 7:
                            c1 = new spread.NumberCondition(4, expect1, formula1);
                            c1.integerValue = isIntegerValue;
                            c2 = new spread.NumberCondition(2, expect2, formula2);
                            c2.integerValue = isIntegerValue;
                            conditionTemp = new spread.RelationCondition(0, c1, c2);
                            break;
                        case 0:
                            conditionTemp = new spread.NumberCondition(0, expect1, formula1);
                            conditionTemp.integerValue = isIntegerValue;
                            break;
                        case 1:
                            conditionTemp = new spread.NumberCondition(1, expect1, formula1);
                            conditionTemp.integerValue = isIntegerValue;
                            break;
                        case 2:
                            conditionTemp = new spread.NumberCondition(2, expect1, formula1);
                            conditionTemp.integerValue = isIntegerValue;
                            break;
                        case 3:
                            conditionTemp = new spread.NumberCondition(3, expect1, formula1);
                            conditionTemp.integerValue = isIntegerValue;
                            break;
                        case 4:
                            conditionTemp = new spread.NumberCondition(4, expect1, formula1);
                            conditionTemp.integerValue = isIntegerValue;
                            break;
                        case 5:
                            conditionTemp = new spread.NumberCondition(5, expect1, formula1);
                            conditionTemp.integerValue = isIntegerValue;
                            break
                    }
                ...
                DefaultDataValidator.createDateValidator = function(typeOperator, v1, v2)
                {
                    ...
                    var conditionTemp = keyword_null,
                        ...
                        c2;
                    var comparisonOperator = spread.ComparisonOperator,
                        dateCompareType = spread.DateCompareType,
                        relationCompareType = spread.RelationCompareType;
                    switch (typeOperator)
                    {
                        case 6:
                            c1 = new spread.DateCondition(5, expect1, formula1);
                            c2 = new spread.DateCondition(3, expect2, formula2);
                            conditionTemp = new spread.RelationCondition(1, c1, c2);
                            break;
                        case 7:
                            c1 = new spread.DateCondition(2, expect1, formula1);
                            c2 = new spread.DateCondition(4, expect2, formula2);
                            conditionTemp = new spread.RelationCondition(0, c1, c2);
                            break;
                        case 0:
                            conditionTemp = new spread.DateCondition(0, expect1, formula1);
                            break;
                        case 1:
                            conditionTemp = new spread.DateCondition(1, expect1, formula1);
                            break;
                        case 2:
                            conditionTemp = new spread.DateCondition(4, expect1, formula1);
                            break;
                        case 3:
                            conditionTemp = new spread.DateCondition(5, expect1, formula1);
                            break;
                        case 4:
                            conditionTemp = new spread.DateCondition(2, expect1, formula1);
                            break;
                        case 5:
                            conditionTemp = new spread.DateCondition(3, expect1, formula1);
                            break
                    }
                    var t = new DefaultDataValidator(conditionTemp);
                    t.type = 4;
                ...
                DefaultDataValidator.createTextLengthValidator = function(typeOperator, v1, v2)
                {
                    ...
                    {
                        case 6:
                            c1 = new spread.TextLengthCondition(3, expect1, formula1);
                            c2 = new spread.TextLengthCondition(5, expect2, formula2);
                            conditionTemp = new spread.RelationCondition(1, c1, c2);
                            break;
                        case 7:
                            c1 = new spread.TextLengthCondition(4, expect1, formula1);
                            c2 = new spread.TextLengthCondition(2, expect2, formula2);
                            conditionTemp = new spread.RelationCondition(0, c1, c2);
                            break;
                        case 0:
                            conditionTemp = new spread.TextLengthCondition(0, expect1, formula1);
                            break;
                        case 1:
                            conditionTemp = new spread.TextLengthCondition(1, expect1, formula1);
                            break;
                        case 2:
                            conditionTemp = new spread.TextLengthCondition(2, expect1, formula1);
                            break;
                        case 3:
                            conditionTemp = new spread.TextLengthCondition(3, expect1, formula1);
                            break;
                        case 4:
                            conditionTemp = new spread.TextLengthCondition(4, expect1, formula1);
                            break;
                        case 5:
                            conditionTemp = new spread.TextLengthCondition(5, expect1, formula1);
                            break
                    }
                    var t = new DefaultDataValidator(conditionTemp);
                    t.type = 6;
                ...
                DefaultDataValidator.createFormulaValidator = function(formula)
                {
                    ...
                    var t = new DefaultDataValidator(new spread.FormulaCondition(4, StringHelper_TrimStart(formula, "=")));
                    t.type = 7;
                    return t
                };
                DefaultDataValidator.createFormulaListValidator = function(formula)
                {
                    ...
                    var t = new DefaultDataValidator(spread.AreaCondition.fromFormula(formula));
                    t.type = 3;
                    return t
                };
                DefaultDataValidator.createListValidator = function(source)
                {
                    ...
                    var t = new DefaultDataValidator(spread.AreaCondition.fromSource(source));
                    t.type = 3;
                    return t
                };
        ...
        spread.DefaultDataValidator = DefaultDataValidator
