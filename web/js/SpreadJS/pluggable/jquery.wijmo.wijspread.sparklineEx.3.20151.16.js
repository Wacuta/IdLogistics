...
(function(wijmo)
{
    (function(spread)
    {
        spread.feature("sparklineEx", ["core.theme"]);
        ...
        spread.SparklineExValue = SparklineExValue;
        var SparklineEx = (function()
            {
                function SparklineEx()
                {
                    ...
                    if (customFunction)
                    {
                        ...
                        this._name = name;
                        if (name && !spread.Calc.Functions.findGlobalFunction(name))
                        {
                            spread.Calc.Functions._customFunctions[name] = customFunction
                        }
                    }
                    this.typeName = ""
                }
        ...
        spread.SparklineEx = SparklineEx;
        ...
        spread.PieSparklineValue = PieSparklineValue;
        var PieSparkline = (function(_super)
            {
                ...
                PieSparkline.prototype.createFunction = function()
                {
                    ...
                    var func = new spread.Calc.Functions.Function("PIESPARKLINE", 1, 255);
                    var self = this;
                ...
                PieSparkline.prototype._fixColors = function(valueCount, colors)
                {
                    ...
                    else
                    {
                        ...
                        {
                            baseColors[i] = spread._Color.parse(newColors[i])
                        }
                        for (var i = colorCount; i < valueCount; i++)
                        {
                            ...
                            newColors[i] = new spread._Color(255, Math_floor(r), Math_floor(g), Math_floor(b)).toString()
                        }
                    }
                    return newColors
                };
        ...
        spread.PieSparkline = PieSparkline;
        ...
        spread.AreaSparklineValue = AreaSparklineValue;
        var AreaSparkline = (function(_super)
            {
                ...
                AreaSparkline.prototype.createFunction = function()
                {
                    ...
                    var func = new spread.Calc.Functions.Function("AREASPARKLINE", 1, 7);
                    var self = this;
                    func.evaluate = function(args)
                    {
        ...
        spread.AreaSparkline = AreaSparkline;
        ...
        spread.ScatterSparklineValue = ScatterSparklineValue;
        var ScatterSparkline = (function(_super)
            {
                ...
                ScatterSparkline.prototype.createFunction = function()
                {
                    ...
                    var func = new spread.Calc.Functions.Function("SCATTERSPARKLINE", 1, 18);
                    var self = this;
                    func.evaluate = function(args)
                    {
        ...
        spread.ScatterSparkline = ScatterSparkline;
        var CompatibleSparkline = (function(_super)
            {
                ...
                {
                    var func = new spread.Calc.Functions.Function(name, 2, 5);
                    var self = this;
                    func.evaluate = function(args)
                    {
                        var args0 = args[0];
                        if (CalcConvert.ref(args0))
                        {
                            ...
                            if (rangesCount > 0)
                            {
                                var dataReference = new spread.Range(args0.getRow(0), args0.getColumn(0), args0.getRowCount(0), args0.getColumnCount(0));
                                ...
                                if (CalcConvert.ref(args2))
                                {
                                    ...
                                    if (rangesCount > 0)
                                    {
                                        dateAxisRange = new spread.Range(args2.getRow(0), args2.getColumn(0), args2.getRowCount(0), args2.getColumnCount(0));
                                        dateAxisOrientation = args[3]
                                    }
                                }
                                var setting = new spread.SparklineSetting,
                                    jsonSetting = args[4];
                                if (jsonSetting)
                                {
                                ...
                                var sparkline = new spread.SparklineValue(-1, -1, dataReference, dataOrientation, type, setting);
                            ...
                            else
                            {
                                if (value !== keyword_null && typeof(value) !== const_undefined)
                                {
                                    if (isDatetime)
                                    {
                                        ...
                                        {
                                            value = spread._DateTimeHelper.fromOADate(value)
                                        }
                                        else
                                        {
                                    ...
                                    {
                                        value = spread.__invalidValuePlaceHolder
                                    }
                                }
                            }
                            ret.push(value)
                ...
                CompatibleSparkline.prototype._paintSparkline = function(context, value, x, y, width, height, sheet)
                {
                    ...
                    var sparkline = value,
                        ...
                        render = new spread.SparklineRender(sparkline),
        ...
        spread.CompatibleSparkline = CompatibleSparkline;
        var LineSparkline = (function(_super)
            {
                ...
                {
                    if (!spread.util.hasCalc() || !spread.features.sparkline)
                    {
                        return keyword_null
                    }
        ...
        spread.LineSparkline = LineSparkline;
        ...
        spread.ColumnSparkline = ColumnSparkline;
        ...
        spread.WinlossSparkline = WinlossSparkline;
        ...
        spread.BulletSparklineValue = BulletSparklineValue;
        var BulletSparkline = (function(_super)
            {
                ...
                BulletSparkline.prototype.createFunction = function()
                {
                    ...
                    var func = new spread.Calc.Functions.Function("BULLETSPARKLINE", 3, 9);
                    var self = this;
                    func.evaluate = function(args)
                    {
                ...
                {
                    var color = spread._Color.parse(colorString);
                    var hls = new spread.HLSColor(color);
        ...
        spread.BulletSparkline = BulletSparkline;
        ...
        spread.SpreadSparklineData = SpreadSparklineData;
        ...
        })(spread.SpreadSparklineStyle || (spread.SpreadSparklineStyle = {}));
        var SpreadSparklineStyle = spread.SpreadSparklineStyle;
        ...
        spread.SpreadSparklineValue = SpreadSparklineValue;
        var SpreadSparkline = (function(_super)
            {
                ...
                SpreadSparkline.prototype.createFunction = function()
                {
                    ...
                    var func = new spread.Calc.Functions.Function("SPREADSPARKLINE", 1, 7);
                    var self = this;
                    func.evaluate = function(args)
                    {
                        var points = self.getAllValuesFromReference(args[0]),
        ...
        spread.SpreadSparkline = SpreadSparkline;
        ...
        })(spread.TextOrientation || (spread.TextOrientation = {}));
        var TextOrientation = spread.TextOrientation;
        ...
        spread.StackedSparklineValue = StackedSparklineValue;
        var StackedSparkline = (function(_super)
            {
                ...
                StackedSparkline.prototype.createFunction = function()
                {
                    ...
                    var func = new spread.Calc.Functions.Function("STACKEDSPARKLINE", 1, 13);
                    var self = this;
                    func.evaluate = function(args)
                    {
                        var points = self.getAllValuesFromReference(args[0]),
                ...
                {
                    var c = spread._Color.parse(backColor);
        ...
        spread.StackedSparkline = StackedSparkline;
        ...
        })(spread.ArrowDirection || (spread.ArrowDirection = {}));
        var ArrowDirection = spread.ArrowDirection;
        ...
        })(spread.BarSparklineType || (spread.BarSparklineType = {}));
        var BarSparklineType = spread.BarSparklineType;
        ...
        spread.BarSparklineBaseValue = BarSparklineBaseValue;
        var BarSparklineBase = (function(_super)
            {
                ...
                BarSparklineBase.prototype.createCustomFunction = function(name, type)
                {
                    ...
                    var func = new spread.Calc.Functions.Function(name, 1, 2);
                    var self = this;
                    func.evaluate = function(args)
                    {
                ...
                BarSparklineBase.prototype.paint = function(context, value, x, y, width, height)
                {
                    ...
                    if (type === 0)
                    {
                        ...
                        if (ratio >= 0)
                        {
                            if (needDrawArrow)
                            {
                                arrow = new spread.Point(x + rectMargin + rectHMaxWidth - arrowMargin, y + height / 2)
                            }
                            rect = new spread.Rect(x + rectMargin, y + height * (1 - rectRatio) / 2, rectHMaxWidth * ratio, rectHMaxHeight);
                            lineStart = new spread.Point(x + rectMargin, y + 1);
                            lineEnd = new spread.Point(x + rectMargin, y + height);
                            arrowDirection = 1
                        }
                        else
                        {
                            ...
                            if (needDrawArrow)
                            {
                                arrow = new spread.Point(x + rectMargin + arrowMargin, y + height / 2)
                            }
                            rect = new spread.Rect(x + width - rectMargin - rectWidth, y + height * (1 - rectRatio) / 2, rectWidth, rectHMaxHeight);
                            lineStart = new spread.Point(x + width - rectMargin, y + 1);
                            lineEnd = new spread.Point(x + width - rectMargin, y + height);
                            arrowDirection = 3
                        }
                        refWidth = height
                    }
                    else if (type === 1)
                    {
                        ...
                        if (ratio >= 0)
                        {
                            ...
                            rect = new spread.Rect(x + (1 - rectRatio) / 2 * width, y + height - rectMargin - rectHeight, rectVMaxWidth, rectHeight);
                            if (needDrawArrow)
                            {
                                arrow = new spread.Point(x + width / 2, y + height - rectMargin - rectHeight + arrowMargin);
                                arrowDirection = 0
                            }
                            lineStart = new spread.Point(x + 1, y + height - rectMargin);
                            lineEnd = new spread.Point(x + width, y + height - rectMargin)
                        }
                        else
                        {
                            var ratio = Math_abs(ratio);
                            rect = new spread.Rect(x + (1 - rectRatio) / 2 * width, y + rectMargin, rectVMaxWidth, rectVMaxHeight * ratio);
                            if (needDrawArrow)
                            {
                                arrow = new spread.Point(x + width / 2, y + rectMargin + rectVMaxHeight - arrowMargin);
                                arrowDirection = 2
                            }
                            lineStart = new spread.Point(x + 1, y + rectMargin);
                            lineEnd = new spread.Point(x + width, y + rectMargin)
                        }
                        refWidth = width
                    }
                    context.beginPath();
        ...
        spread.BarSparklineBase = BarSparklineBase;
        ...
        spread.HBarSparkline = HBarSparkline;
        ...
        spread.VBarSparkline = VBarSparkline;
        (function(BoxPlotStyle)
        {
            BoxPlotStyle[BoxPlotStyle["Classical"] = 0] = "Classical";
            BoxPlotStyle[BoxPlotStyle["Neo"] = 1] = "Neo"
        })(spread.BoxPlotStyle || (spread.BoxPlotStyle = {}));
        var BoxPlotStyle = spread.BoxPlotStyle;
        ...
        spread.BoxPlotSparklineValue = BoxPlotSparklineValue;
        var BoxPlotSparkline = (function(_super)
            {
                ...
                BoxPlotSparkline.prototype.createFunction = function()
                {
                    ...
                    var func = new spread.Calc.Functions.Function("BOXPLOTSPARKLINE", 1, 10);
                    var self = this;
                    func.evaluate = function(args)
                    {
                ...
                BoxPlotSparkline.prototype._getPercentitleValue = function(reference, dValue)
                {
                    ...
                    {
                        var func = spread.Calc.Functions._builtInFunctions["PERCENTILE"];
                ...
                BoxPlotSparkline.prototype._getStDevpValue = function(reference)
                {
                    ...
                    {
                        var func = spread.Calc.Functions._builtInFunctions["STDEVP"];
        ...
        spread.BoxPlotSparkline = BoxPlotSparkline;
        ...
        spread.VariSparklineValue = VariSparklineValue;
        var VariSparkline = (function(_super)
            {
                ...
                VariSparkline.prototype.createFunction = function()
                {
                    ...
                    var func = new spread.Calc.Functions.Function("VARISPARKLINE", 1, 10);
                    var self = this;
                    func.evaluate = function(args)
                    {
        ...
        spread.VariSparkline = VariSparkline;
        ...
        spread.AccumulateSparklineBase = AccumulateSparklineBase;
        ...
        spread.CascadeSparklineValue = CascadeSparklineValue;
        var CascadeSparkline = (function(_super)
            {
                ...
                CascadeSparkline.prototype.createFunction = function()
                {
                    ...
                    var func = new spread.Calc.Functions.Function("CASCADESPARKLINE", 1, 8);
                    var self = this;
                    func.evaluate = function(args)
                    {
                        var points = self.getAllValuesFromReference(args[0]),
        ...
        spread.CascadeSparkline = CascadeSparkline;
        ...
        spread.ParetoSparklineValue = ParetoSparklineValue;
        var ParetoSparkline = (function(_super)
            {
                ...
                ParetoSparkline.prototype.createFunction = function()
                {
                    ...
                    var func = new spread.Calc.Functions.Function("PARETOSPARKLINE", 1, 8);
                    var self = this;
                    func.evaluate = function(args)
                    {
                        var points = self.getAllValuesFromReference(args[0]),
        ...
        spread.ParetoSparkline = ParetoSparkline
