...
(function(wijmo)
{
    (function(spread)
    {
        spread.feature("floatingObject", ["core.common", "core.stringResource", "core.sheet_action", "core.imageLoader"]);
        ...
        })(spread.FloatingObjectType || (spread.FloatingObjectType = {}));
        var FloatingObjectType = spread.FloatingObjectType;
        var _FloatingObjectArray = (function(_super)
            {
                ...
                _FloatingObjectArray.prototype.add = function(item)
                {
                    ...
                    {
                        throw new Error(spread.SR.Exp_FloatingObjectNameEmptyError);
                    }
                ...
                _FloatingObjectArray.prototype._checkObjectExists = function(name)
                {
                    ...
                    {
                        throw new Error(spread.SR.Exp_FloatingObjectHasSameNameError);
                    }
                };
        ...
        spread._FloatingObjectArray = _FloatingObjectArray;
        var FloatingObject = (function()
            {
                function FloatingObject(name, x, y, width, height)
                {
                    ...
                    var self = this;
                    self._name = name;
                    self._location = new spread.Rect((typeof x === 'number') ? x : 0, (typeof y === 'number') ? y : 0, (typeof width === 'number') ? width : 0, (typeof height === 'number') ? height : 0);
                    self._canPrint = true;
                    self._isLocked = true;
                ...
                FloatingObject.prototype.position = function(position)
                {
                    ...
                    if (arguments.length === 0)
                    {
                        return new spread.Point(self._location.x, self._location.y)
                    }
                    if (position instanceof spread.Point)
                    {
                ...
                FloatingObject.prototype.fromJSON = function(jsData, isNoneSchema)
                {
                    ...
                    self._location = new spread.Rect(jsonX, jsonY, jsonWidth, jsonHeight);
        ...
        spread.FloatingObject = FloatingObject;
        ...
        spread.CustomFloatingObject = CustomFloatingObject;
        var Picture = (function(_super)
            {
                ...
                Picture.prototype.pictureStretch = function(value)
                {
                    ...
                    if (self._pictureStretch !== value && spread.ImageLayout[value] !== keyword_undefined)
                    {
                        var sheet = self.owner();
                        if (sheet)
                        {
                ...
                Picture.prototype._loadImage = function()
                {
                    ...
                    {
                        self._imageLoader = new spread._GcImageLoader(function()
                        {
                            self._loadImage()
                        })
                    }
        ...
        var _FloatingObjectRender = (function()
            {
                ...
                _FloatingObjectRender.prototype.render = function(containerRect, contentRect)
                {
                    ...
                    if (!self._floatingObjectContentDiv)
                    {
                        ...
                        if (typeof self._floatingObject.borderWidth === 'function')
                        {
                            ...
                            $(self._borderDiv).addClass(CSS_CLASS_NONE_USER_SELECT);
                ...
                _FloatingObjectRender.prototype._paintImage = function()
                {
                    ...
                    var backColor = spread._ThemeContext.getColor(floatingObject.owner(), floatingObject.backColor());
                    ...
                    if (floatingObject._isImageLoaded)
                    {
                        ...
                        spread.util._applyBackgroundImageLayout(self._floatingObjectContentDiv, contentWidth, contentHeight, imgWidth, imgHeight, stretch)
                    }
                };
                _FloatingObjectRender.prototype._applyBorderStyle = function(contentRect, containerRect)
                {
                    var borderDiv = this._borderDiv,
                        ...
                        borderColor = spread._ThemeContext.getColor(floatingObject.owner(), floatingObject.borderColor()),
                ...
                _FloatingObjectRender.prototype._createFloatingObjectContainer = function(floatingObjectName)
                {
                    ...
                    {
                        self._touchManager = new spread.FloatingObjectTouchManager(outer, self, self._sheet.parent._touchEventProvider);
                ...
                _FloatingObjectRender.prototype._doMouseDown = function(event)
                {
                    ...
                    if (event.button === 0 || event.button === 2)
                    {
                        ...
                        self._mouseLeftButtonDownPosition = new spread.Point(event.pageX - canvasOffset.left, event.pageY - canvasOffset.top);
                ...
                _FloatingObjectRender.prototype._doCopyFloatingObject = function(startPoint, endPoint)
                {
                    ...
                    if (self._moveInfo)
                    {
                        ...
                        var dragCopyFloatingObjectUndoAction = new spread.UndoRedo.DragCopyFloatingObjectUndoAction(sheet, {names: names}, {
                ...
                _FloatingObjectRender.prototype._doMoveFloatingObject = function(startPoint, endPoint)
                {
                    ...
                    if (self._moveInfo)
                    {
                        ...
                        var movingFloatingObjectUndoAction = new spread.UndoRedo.MovingFloatingObjectUndoAction(sheet, {names: names}, {
                                offsetX: offsetX, offsetY: offsetY
                            });
                ...
                _FloatingObjectRender.prototype._doResizeFloatingObject = function()
                {
                    ...
                    if (self._resizeInfo)
                    {
                        ...
                        var resizingFloatingObjectUndoAction = new spread.UndoRedo.ResizingFloatingObjectUndoAction(sheet, {names: names}, {
                ...
                _FloatingObjectRender.prototype._doResizeContainer = function(point, hitInfo)
                {
                    if (hitInfo)
                    {
                        ...
                        point = new spread.Point(point.x - layout.x, point.y - layout.y);
                ...
                _FloatingObjectRender.prototype._getHTMLElementBounds = function(element)
                {
                    ...
                    return new spread.Rect(position.left, position.top, $element.width(), $element.height())
                };
                ...
                _FloatingObjectRender.prototype._hitTest = function(mouseX, mouseY)
                {
                    ...
                    var topLeftRect = self._inflateRect(new spread.Rect(x, y, visibleGapSize, visibleGapSize), inflateSize);
                    if (topLeftRect.contains(mouseX, mouseY))
                    {
                        info.inTopNWSEResizing = true;
                        return info
                    }
                    var topCenterRect = self._inflateRect(new spread.Rect(x + width / 2 - visibleGapSize, y, 2 * visibleGapSize, visibleGapSize), inflateSize);
                    if (topCenterRect.contains(mouseX, mouseY))
                    {
                        info.inTopNSResizing = true;
                        return info
                    }
                    var topRightRect = self._inflateRect(new spread.Rect(x + width - visibleGapSize, y, visibleGapSize, visibleGapSize), inflateSize);
                    if (topRightRect.contains(mouseX, mouseY))
                    {
                        info.inTopNESWResizing = true;
                        return info
                    }
                    var middleLeftRect = self._inflateRect(new spread.Rect(x, y + height / 2 - visibleGapSize, visibleGapSize, 2 * visibleGapSize), inflateSize);
                    if (middleLeftRect.contains(mouseX, mouseY))
                    {
                        info.inLeftWEResizing = true;
                        return info
                    }
                    var middleRightRect = self._inflateRect(new spread.Rect(x + width - visibleGapSize, y + height / 2 - visibleGapSize, visibleGapSize, 2 * visibleGapSize), inflateSize);
                    if (middleRightRect.contains(mouseX, mouseY))
                    {
                        info.inRightWEResizing = true;
                        return info
                    }
                    var bottomLeftRect = self._inflateRect(new spread.Rect(x, y + height - visibleGapSize, visibleGapSize, visibleGapSize), inflateSize);
                    if (bottomLeftRect.contains(mouseX, mouseY))
                    {
                        info.inBottomNESWResizing = true;
                        return info
                    }
                    var bottomCenterRect = self._inflateRect(new spread.Rect(x + width / 2 - visibleGapSize, y + height - visibleGapSize, 2 * visibleGapSize, visibleGapSize), inflateSize);
                    if (bottomCenterRect.contains(mouseX, mouseY))
                    {
                        info.inBottomNSReszing = true;
                        return info
                    }
                    var bottomRightRect = self._inflateRect(new spread.Rect(x + width - visibleGapSize, y + height - visibleGapSize, visibleGapSize, visibleGapSize), inflateSize);
                ...
                _FloatingObjectRender.prototype._inflateRect = function(rect, size)
                {
                    ...
                    return new spread.Rect(x, y, width >= 0 ? width : 0, height >= 0 ? height : 0)
                };
                _FloatingObjectRender._resizeIndicatorSize = 7;
                return _FloatingObjectRender
            })();
        spread._FloatingObjectRender = _FloatingObjectRender;
        var _FloatingObjectRenderManager = (function()
            {
                ...
                _FloatingObjectRenderManager.prototype._render = function(rowViewportIndex, columnViewportIndex, zoomFactor)
                {
                    ...
                    for (i = 0; i < fOLayoutModelLength; i++)
                    {
                        ...
                        container.render(new spread.Rect(outContainerLeft, outContainerTop, outContainerWidth, outContainerHeight).getIntersectRect(clipRect) || new spread.Rect(outContainerLeft, outContainerTop, 0, 0), new spread.Rect(leftOffset, topOffset, layout.width, layout.height))
                    }
                };
                ...
                _FloatingObjectRenderManager.prototype._getViewportRect = function(rowViewportIndex, columnViewportIndex)
                {
                    ...
                    return rect.getIntersect(x, y, width, height) || new spread.Rect(0, 0, 0, 0)
                };
        ...
        spread._FloatingObjectRenderManager = _FloatingObjectRenderManager;
        ...
        spread._FloatingObjectLayout = _FloatingObjectLayout;
        ...
        spread.NamedObjectArray = NamedObjectArray
