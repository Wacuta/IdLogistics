...
(function(wijmo)
{
    (function(_spread)
    {
        ...
        var FormulaTextBox = (function()
            {
                function FormulaTextBox(host, spread)
                {
                    ...
                    if (spread)
                    {
                        ...
                        self._spread._unbind(_spread.Events.ActiveSheetChanging, FormulatextboxAcrossSheetSingleton.handleFormulatextboxAcrossSheetBeforeTabChange);
                        self._spread._bind(_spread.Events.ActiveSheetChanging, FormulatextboxAcrossSheetSingleton.handleFormulatextboxAcrossSheetBeforeTabChange);
                        self._spread._unbind(_spread.Events.ActiveSheetChanged, FormulatextboxAcrossSheetSingleton.handleFormulatextboxAcrossSheetAfterTabChange);
                        self._spread._bind(_spread.Events.ActiveSheetChanged, FormulatextboxAcrossSheetSingleton.handleFormulatextboxAcrossSheetAfterTabChange)
                    }
                ...
                FormulaTextBox.prototype.text = function(value)
                {
                    ...
                    if (value !== self.text())
                    {
                        ...
                        var parameter = {};
                        var ftbAcrossSheet = _spread.IFormulatextboxAcrossSheetSingleton.formulatextboxAcrossSheetInstance;
                ...
                FormulaTextBox.prototype.appendRange = function(rangeString, replacing, clearPrevAppending)
                {
                    ...
                    else
                    {
                        var tokens = self._tokens,
                            activeTokenIndex = _spread.ArrayHelper.indexOf(tokens, activeToken);
                        if (caretPosition > appendingStart)
                        {
                            tokens.splice(activeTokenIndex + 1, 0, {
                                text: wijmo.spread.CR.listSeparator, type: 8
                            });
                ...
                FormulaTextBox.prototype._startSpreadEdit = function()
                {
                    ...
                    var EditorStatus = wijmo.spread.EditorStatus,
                ...
                FormulaTextBox.prototype.parseByCalc = function(text)
                {
                    if (_spread.Calc)
                    {
                        ...
                        var oldOption = wijmo.spread.Calc.Parser.getParserOption();
                        var option = {
                                numberDecimalSeparator: _spread.CR.numberDecimalSeparator, arrayGroupSeparator: _spread.CR.arrayGroupSeparator, listSeparator: _spread.CR.listSeparator
                            };
                        _spread.Calc.Parser.setParserOption(option);
                        var parser = new _spread.Calc.Parser;
                        var tokens2 = parser.parseReferenceExpressionInfos(text, self._activeSheet(), self._activeRow(), self._activeCol());
                        wijmo.spread.Calc.Parser.setParserOption(oldOption);
                ...
                FormulaTextBox.prototype._convertToTextboxToken = function(tokenList)
                {
                    ...
                    if (wijmo.spread.CR && wijmo.spread.CR.arrayGroupSeparator)
                    {
                        arrayGroupSeperator = wijmo.spread.CR.arrayGroupSeparator
                    }
                    var isInArray = false;
                ...
                {
                    var excelFormulaTokenType = _spread.Calc.ExcelFormulaTokenType;
                    var excelFormulaTokenSubtype = _spread.Calc.ExcelFormulaTokenSubtype;
                    var type = token.type;
                ...
                FormulaTextBox.prototype._getCustomNames = function(spread, sheet)
                {
                    ...
                    {
                        names.push({
                            name: customNames[i].getName(), description: _spread.SR.Fbx_CustomName_Description + customNames[i].getName()
                        })
                    }
                    return names
                };
                FormulaTextBox.prototype._getTableNames = function(sheet)
                {
                    ...
                    if (tables)
                    {
                        ...
                        {
                            names.push({
                                name: tables[i].name(), description: _spread.SR.Fbx_TableName_Description + tables[i].name()
                            })
                        }
                    }
                    return names
                ...
                FormulaTextBox.prototype._getFuncsStartWith = function(startName, funcs)
                {
                    ...
                    if (_spread.StringUtil.contains(startName, '['))
                    {
                        startName = startName.substr(startName.lastIndexOf('[') + 1);
                        startName = _spread.StringUtil.replace(startName, '@', '')
                    }
                    var results = [];
                ...
                FormulaTextBox.prototype._getFuncsForInput = function()
                {
                    ...
                    {
                        funcs = funcs.concat(tableColumnNames).concat(_spread.SR.getHelpTableFuncs());
                        if (_spread.StringUtil.endsWith(tokenText, '[') || _spread.StringUtil.endsWith(tokenText, '[@'))
                        {
                            return funcs
                        }
                    }
                ...
                FormulaTextBox.prototype._getTableColumnNames = function(tokenIndex)
                {
                    ...
                    if (sheet)
                    {
                        ...
                        var table = sheet.findTableByName(_spread.StringUtil.leftBefore(token.text, '['));
                ...
                FormulaTextBox.prototype._completeFunc = function()
                {
                    ...
                    if (_spread.StringUtil.contains(curTokenText, '['))
                    {
                ...
                FormulaTextBox.prototype._openFuncHelp = function()
                {
                    ...
                    if (show)
                    {
                        ...
                        var helpSummary = "<div class='gcsj-func-help-section'>" + "<div class='gcsj-func-help-section-title'>" + _spread.SR.Fbx_Summary + "</div>" + "<div class='gcsj-func-help-section-content'>" + func.description + "</div>" + "</div>";
        ...
        var Tokenizer = (function()
            {
                ...
                Tokenizer.parse = function(formula)
                {
                    ...
                    var fLength = (formula && formula.length),
                        ...
                        ch,
                        tokenTxt = "";
                    var arrayArgumentSepatator = (wijmo.spread.CR.listSeparator === wijmo.spread.CR.arrayGroupSeparator) ? '\\' : wijmo.spread.CR.listSeparator;
                    var listSeparator = wijmo.spread.CR.listSeparator;
                    var arrayGroupSeparator = wijmo.spread.CR.arrayGroupSeparator;
        ...
        _spread.FormulatextboxAcrossSheet = FormulatextboxAcrossSheet;
        var FormulatextboxAcrossSheetSingleton = (function(_super)
            {
                ...
                FormulatextboxAcrossSheetSingleton.handleFormulatextboxAcrossSheetBeforeTabChange = function(e, eData)
                {
                    ...
                    if (!_spread.IFormulatextboxAcrossSheetSingleton.formulatextboxAcrossSheetInstance)
                    {
                        _spread.IFormulatextboxAcrossSheetSingleton.formulatextboxAcrossSheetInstance = new FormulatextboxAcrossSheet
                    }
                    _spread.IFormulatextboxAcrossSheetSingleton.formulatextboxAcrossSheetInstance.handleFormulatextboxBeforeChange(oldSheet, newSheet)
                };
                FormulatextboxAcrossSheetSingleton.handleFormulatextboxAcrossSheetAfterTabChange = function(e, eData)
                {
                    ...
                    _spread.IFormulatextboxAcrossSheetSingleton.formulatextboxAcrossSheetInstance.handleFormulatextboxAfterChange(oldSheet, newSheet)
                };
                return FormulatextboxAcrossSheetSingleton
            })(_spread.IFormulatextboxAcrossSheetSingleton);
        _spread.FormulatextboxAcrossSheetSingleton = FormulatextboxAcrossSheetSingleton
