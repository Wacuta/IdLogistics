...
(function(wijmo)
{
    (function(spread)
    {
        spread.feature("table", ["core.common", "core.stringResource"]);
        ...
        var SheetTable = (function()
            {
                ...
                {
                    var self = this;
                    return new spread.Range(self._row, self._col, self._rowCount, self._colCount)
                };
                SheetTable.prototype.dataRange = function()
                {
                    ...
                    return new spread.Range(r, self._col, rc, self._colCount)
                };
                ...
                {
                    var self = this;
                    if (!self._rowFilter && spread.features.filter)
                    {
                        self._rowFilter = new spread._TableFilter(self);
                    ...
                    if (tcs)
                    {
                        if (0 <= tableColumnIndex && tableColumnIndex < tcs.length)
                        {
                            ...
                            if (tc)
                            {
                                ...
                                {
                                    name = spread.util.toString(name)
                                }
                                return name
                            }
                        }
                ...
                SheetTable.prototype._compose = function(row, col, dest)
                {
                    ...
                    else
                    {
                        ...
                        if (spread._CacheMgr._cached && spread._CacheMgr._visibleRowIndexCache)
                        {
                            var relativeRowCatch = spread._CacheMgr._visibleRowIndexCache;
                ...
                SheetTable.prototype._moveTo = function(row, col)
                {
                    ...
                    if (sheet)
                    {
                        ...
                        {
                            throw new Error(spread.SR.Exp_TableMoveOutOfRange);
                        }
                ...
                SheetTable.prototype._resize = function(rowCount, colCount, ignoreUpdateDataSource)
                {
                    ...
                    {
                        throw new Error(spread.SR.Exp_TableResizeOutOfRange);
                    }
                    var sheet = self._getSheet();
                    if (sheet)
                    {
                ...
                SheetTable.prototype._syncHeader = function(start, count)
                {
                    ...
                    for (var i = start; i < end; i++)
                    {
                        ...
                        if (tc)
                        {
                            ...
                            var index = spread.util.inArray(self, tableList);
                            if (index > -1)
                            {
                ...
                SheetTable.prototype._clear = function(row, col, rowCount, colCount)
                {
                    ...
                    var clearRange = new spread.Range(r, c, rc, cc);
                    var headerIndex = self.headerIndex();
                    if (self._showHeader && r <= headerIndex && headerIndex < r + rc)
                    {
                        var headerRange = new spread.Range(headerIndex, self._col, 1, self._colCount);
                    ...
                    {
                        var footerRange = new spread.Range(footerIndex, self._col, 1, self._colCount);
                ...
                SheetTable.prototype.fromJSON = function(jsData, isNoneSchema)
                {
                    ...
                    if (isNoneSchema)
                    {
                        if (jsData.dataSource && spread.features.binding)
                        {
                            self._bindingManager = new spread._BindingManager;
                            self._bindingManager.bind(jsData.dataSource)
                        }
                        if (jsData.dataBinding && spread.features.binding)
                        {
                            self._bindingManager = new spread._BindingManager;
                    ...
                    else
                    {
                        if (jsData.bindingPath)
                        {
                            ...
                            if (spread.CellBindingSource && dataSource instanceof spread.CellBindingSource)
                            {
                                var actualDataSource = spread._BindingHelper.getValueByPath(dataSource.getSource(), jsData.bindingPath);
                                if (actualDataSource)
                                {
                                    self._bindingManager = new spread._BindingManager;
                    ...
                    if (jsData.rowFilter && spread.features.filter)
                    {
                        var rowFilterData = jsData.rowFilter;
                        var filter = new spread._TableFilter;
                        filter.table(self);
                ...
                SheetTable.prototype._applyBindingPath = function()
                {
                    ...
                    if (path && spread.CellBindingSource && dataSource instanceof spread.CellBindingSource)
                    {
                        var actualDataSource = spread._BindingHelper.getValueByPath(dataSource.getSource(), path);
                        if (actualDataSource)
                        {
                            var dataRange = self.dataRange(),
                            ...
                            var bindingManager = new spread._BindingManager;
                ...
                {
                    var newBindingManager = new spread._BindingManager;
        ...
        spread.TableColumnInfo = TableColumnInfo;
        var TableStyleInfo = (function()
            {
                ...
                TableStyleInfo.prototype.fromJSON = function(jsData, isNoneSchema)
                {
                    ...
                    {
                        var horizontal = new spread.LineBorder;
                    ...
                    {
                        var vertical = new spread.LineBorder;
        ...
        spread.TableStyleInfo = TableStyleInfo;
        ...
        var TableStyles = (function()
            {
                ...
                TableStyles.addCustomStyles = function(style)
                {
                    ...
                    for (var i = 0; i < count; i++)
                    {
                        ...
                        {
                            throw new Error(spread.SR.Exp_TableStyleAddCustomStyleError);
                        }
                    }
                    styles.push(style)
                };
                TableStyles.removeCustomStyle = function(style)
                {
                    ...
                    if (styles)
                    {
                        var index = spread.util.inArray(style, styles);
                        if (index > -1)
                        {
                ...
                TableStyles._createLightA = function(factor)
                {
                    ...
                    headerRowStyle.borderBottom = new spread.LineBorder(themeColor, 1);
                    ...
                    wholeTableStyle.borderTop = new spread.LineBorder(themeColor, 1);
                    wholeTableStyle.borderBottom = new spread.LineBorder(themeColor, 1);
                    ...
                    footerRowStyle.borderTop = new spread.LineBorder(themeColor, 1);
                ...
                TableStyles._createLightB = function(factor)
                {
                    ...
                    style.headerRowStyle(headerRowStyle);
                    var wholeTableStyle = new TableStyleInfo;
                    wholeTableStyle.borderLeft = new spread.LineBorder(themeColor, 1);
                    wholeTableStyle.borderTop = new spread.LineBorder(themeColor, 1);
                    wholeTableStyle.borderBottom = new spread.LineBorder(themeColor, 1);
                    wholeTableStyle.borderRight = new spread.LineBorder(themeColor, 1);
                    style.wholeTableStyle(wholeTableStyle);
                    var firstRowStripStyle = new TableStyleInfo;
                    firstRowStripStyle.borderTop = new spread.LineBorder(themeColor, 1);
                    style.firstRowStripStyle(firstRowStripStyle);
                    var secondRowStripStyle = new TableStyleInfo;
                    secondRowStripStyle.borderTop = new spread.LineBorder(themeColor, 1);
                    style.secondRowStripStyle(secondRowStripStyle);
                    var firstColumnStripStyle = new TableStyleInfo;
                    firstColumnStripStyle.borderLeft = new spread.LineBorder(themeColor, 1);
                    style.firstColumnStripStyle(firstColumnStripStyle);
                    var secondColumnStripStyle = new TableStyleInfo;
                    secondColumnStripStyle.borderLeft = new spread.LineBorder(themeColor, 1);
                    ...
                    style.highlightLastColumnStyle(highlightLastColumnStyle);
                    var footerRowStyle = new TableStyleInfo;
                    footerRowStyle.borderTop = new spread.LineBorder(themeColor, 6);
                    footerRowStyle.font = "bold 10pt arial";
                    style.footerRowStyle(footerRowStyle);
                    return style
                };
                TableStyles._createLightC = function(factor)
                {
                    ...
                    var style = new TableStyle;
                    var headerRowStyle = new TableStyleInfo;
                    headerRowStyle.borderBottom = new spread.LineBorder(themeColor, 2);
                    headerRowStyle.font = "bold 10pt arial";
                    style.headerRowStyle(headerRowStyle);
                    var wholeTableStyle = new TableStyleInfo;
                    wholeTableStyle.borderLeft = new spread.LineBorder(themeColor, 1);
                    ...
                    wholeTableStyle.borderRight = new spread.LineBorder(themeColor, 1);
                    wholeTableStyle.borderBottom = new spread.LineBorder(themeColor, 1);
                    wholeTableStyle.borderHorizontal = new spread.LineBorder(themeColor, 1);
                    wholeTableStyle.borderVertical = new spread.LineBorder(themeColor, 1);
                    style.wholeTableStyle(wholeTableStyle);
                    var firstRowStripStyle = new TableStyleInfo;
                    firstRowStripStyle.backColor = bkStrip1;
                    style.firstRowStripStyle(firstRowStripStyle);
                ...
                TableStyles._createMediumA = function(factor)
                {
                    ...
                    style.headerRowStyle(headerRowStyle);
                    var wholeTableStyle = new TableStyleInfo;
                    wholeTableStyle.borderHorizontal = new spread.LineBorder(border, 1);
                    wholeTableStyle.borderLeft = new spread.LineBorder(border, 1);
                    wholeTableStyle.borderRight = new spread.LineBorder(border, 1);
                    wholeTableStyle.borderBottom = new spread.LineBorder(border, 1);
                    wholeTableStyle.borderTop = new spread.LineBorder(border, 1);
                    style.wholeTableStyle(wholeTableStyle);
                    var firstRowStripStyle = new TableStyleInfo;
                    firstRowStripStyle.backColor = bkStrip1;
                    style.firstRowStripStyle(firstRowStripStyle);
                    ...
                    style.highlightLastColumnStyle(highlightLastColumnStyle);
                    var footerRowStyle = new TableStyleInfo;
                    footerRowStyle.borderTop = new spread.LineBorder(border, 6);
                    footerRowStyle.font = "bold 10pt arial";
                ...
                TableStyles._createMediumB = function(factor)
                {
                    ...
                    var headerRowStyle = new TableStyleInfo;
                    headerRowStyle.backColor = bkHeader;
                    headerRowStyle.borderBottom = new spread.LineBorder(borderColor, 2);
                    headerRowStyle.borderVertical = new spread.LineBorder(borderColor, 1);
                    headerRowStyle.font = "bold 10pt arial";
                    headerRowStyle.foreColor = "white";
                    style.headerRowStyle(headerRowStyle);
                    var wholeTableStyle = new TableStyleInfo;
                    wholeTableStyle.borderHorizontal = new spread.LineBorder(borderColor, 1);
                    wholeTableStyle.borderVertical = new spread.LineBorder(borderColor, 1);
                    ...
                    style.highlightLastColumnStyle(highlightLastColumnStyle);
                    var footerRowStyle = new TableStyleInfo;
                    footerRowStyle.borderTop = new spread.LineBorder(borderColor, 2);
                    footerRowStyle.borderVertical = new spread.LineBorder(borderColor, 1);
                ...
                TableStyles._createMediumC = function(factor)
                {
                    ...
                    var headerRowStyle = new TableStyleInfo;
                    headerRowStyle.backColor = bkHeader;
                    headerRowStyle.borderTop = new spread.LineBorder("black", 2);
                    headerRowStyle.borderBottom = new spread.LineBorder("black", 2);
                    headerRowStyle.font = "bold 10pt arial";
                    headerRowStyle.foreColor = "white";
                    style.headerRowStyle(headerRowStyle);
                    var wholeTableStyle = new TableStyleInfo;
                    wholeTableStyle.borderLeft = new spread.LineBorder(border, 1);
                    wholeTableStyle.borderRight = new spread.LineBorder(border, 1);
                    wholeTableStyle.borderTop = new spread.LineBorder("black", 2);
                    wholeTableStyle.borderVertical = new spread.LineBorder(border, 1);
                    if (factor === 0)
                    {
                        wholeTableStyle.borderHorizontal = new spread.LineBorder(border, 1)
                    }
                    wholeTableStyle.borderBottom = new spread.LineBorder("black", 2);
                    style.wholeTableStyle(wholeTableStyle);
                    var firstRowStripStyle = new TableStyleInfo;
                    firstRowStripStyle.backColor = bkStrip1;
                    style.firstRowStripStyle(firstRowStripStyle);
                    ...
                    var footerRowStyle = new TableStyleInfo;
                    footerRowStyle.foreColor = "black";
                    footerRowStyle.borderTop = new spread.LineBorder("black", 6);
                    style.footerRowStyle(footerRowStyle);
                    return style
                };
                TableStyles._createMediumD = function(factor)
                {
                    ...
                    var headerRowStyle = new TableStyleInfo;
                    headerRowStyle.backColor = bkHeader;
                    headerRowStyle.borderVertical = new spread.LineBorder(border, 1);
                    headerRowStyle.borderLeft = new spread.LineBorder(border, 1);
                    headerRowStyle.borderTop = new spread.LineBorder(border, 1);
                    headerRowStyle.borderRight = new spread.LineBorder(border, 1);
                    headerRowStyle.borderBottom = new spread.LineBorder(border, 1);
                    headerRowStyle.font = "bold 10pt arial";
                    ...
                    footerRowStyle.foreColor = "black";
                    footerRowStyle.font = "bold 10pt arial";
                    footerRowStyle.borderLeft = new spread.LineBorder(border, 1);
                    footerRowStyle.borderTop = new spread.LineBorder(footerBorder, 2);
                    footerRowStyle.borderRight = new spread.LineBorder(border, 1);
                    footerRowStyle.borderBottom = new spread.LineBorder(border, 1);
                    footerRowStyle.borderVertical = new spread.LineBorder(border, 1);
                    style.footerRowStyle(footerRowStyle);
                    return style
                };
                ...
                TableStyles._createDarkA = function(factor)
                {
                    ...
                    headerRowStyle.font = "bold 10pt arial";
                    headerRowStyle.foreColor = "white";
                    headerRowStyle.borderBottom = new spread.LineBorder("white", 2);
                    style.headerRowStyle(headerRowStyle);
                    var wholeTableStyle = new TableStyleInfo;
                    ...
                    var highlightFirstColumnStyle = new TableStyleInfo;
                    highlightFirstColumnStyle.font = "bold 10pt arial";
                    highlightFirstColumnStyle.borderRight = new spread.LineBorder("white", 2);
                    highlightFirstColumnStyle.backColor = bkStrip1;
                    highlightFirstColumnStyle.foreColor = "white";
                    style.highlightFirstColumnStyle(highlightFirstColumnStyle);
                    var highlightLastColumnStyle = new TableStyleInfo;
                    highlightLastColumnStyle.font = "bold 10pt arial";
                    highlightLastColumnStyle.borderLeft = new spread.LineBorder("white", 2);
                    ...
                    footerRowStyle.font = "bold 10pt arial";
                    footerRowStyle.foreColor = "white";
                    footerRowStyle.borderTop = new spread.LineBorder("white", 2);
                    style.footerRowStyle(footerRowStyle);
                    return style
                };
        ...
        spread.TableStyles = TableStyles;
        var _SheetTableManager = (function()
            {
                ...
                _SheetTableManager.prototype.add = function(table)
                {
                    ...
                    for (var i = 0; i < count; i++)
                    {
                        ...
                        {
                            throw new Error(spread.SR.Exp_TableHasSameNameError);
                        }
                    }
                ...
                _SheetTableManager.prototype.remove = function(table, clearValue)
                {
                    ...
                    var index = spread.util.inArray(table, this._tableList);
                    if (index > -1)
                    {
                ...
                _SheetTableManager.prototype.addRows = function(row, count)
                {
                    ...
                    for (var i = 0, tablesCount = tables.length; i < tablesCount; i++)
                    {
                        ...
                        if (spread.ArrayHelper.contains(handledDataSources, dataSource))
                        {
                ...
                {
                    var self = this;
                    var clearRange = new spread.Range(row, col, rowCount, colCount);
                    var count,
                        t;
                    if ((type & 1) === 1)
                    {
        ...
        spread._SheetTableManager = _SheetTableManager
