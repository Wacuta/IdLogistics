...
slcanvas.xappath = './ClientBin/SxBridge.xap';
//TODO: must replace this xap path to static on internet!!
slcanvas.internetXapPath = './ClientBin/SxBridge.xap';
// remove the following two lines if self-hosted
if (window.location.href.indexOf('://localhost') == -1)
    slcanvas.xappath = slcanvas.internetXapPath;
