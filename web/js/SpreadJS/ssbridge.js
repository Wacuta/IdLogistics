(function () {
    ...
    var defaultRowHeaderColCount = 1;
    var defaultColHeaderRowCount = 1;
    ...
    function doSheetObjectFromJSON(spreadObject, sheetJson, isNoneSchema) {
        ...
        //header count
        var rowHeaderColCount = jsonData.rowHeaderColCount;
        if (typeof(rowHeaderColCount) === const_undefined) {
            rowHeaderColCount = defaultRowHeaderColCount;
        }
        t.SetColumnCount(name, rowHeaderColCount, SheetArea.rowHeader);
        var colHeaderRowCount = jsonData.colHeaderRowCount;
        if (typeof (colHeaderRowCount) === const_undefined) {
            colHeaderRowCount = defaultColHeaderRowCount;
        }
        t.SetRowCount(name, colHeaderRowCount, SheetArea.colHeader);
    ...
    function doFilterFromJSON(spreadObject, sheetName, tableName, rowFilter, isNoneSchema) {
        ...
        if (rowFilter.filteredColumns) {
            for (var i = 0; i < rowFilter.filteredColumns.length; i++) {
                var filteredCol = rowFilter.filteredColumns[i];
